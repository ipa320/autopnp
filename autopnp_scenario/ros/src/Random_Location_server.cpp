...
#include <autopnp_scenario/Random_LocationAction.h>
...
class Random_Location_Server
	{
		protected:
			ros::NodeHandle nh_;
			actionlib::SimpleActionServer<autopnp_scenario::Random_LocationAction> rl;
			std::string action_name_;
			autopnp_scenario::Random_LocationFeedback feedback_;
			autopnp_scenario::Random_LocationResult result_;
		...
		public:
			...
			void executeCB(const autopnp_scenario::Random_LocationGoalConstPtr &goal)
				{
					ros::Rate r(1);

...
#include <autopnp_scenario/Inspect_RoomAction.h>
...
class Inspect_Room_Server
	{
		protected:
			ros::NodeHandle nh_;
			actionlib::SimpleActionServer<autopnp_scenario::Inspect_RoomAction> irs_;
			std::string action_name_;
			autopnp_scenario::Inspect_RoomFeedback feedback_;
			autopnp_scenario::Inspect_RoomResult result_;
		...
		public:
			...
			void executeCB(const autopnp_scenario::Inspect_RoomGoalConstPtr &goal)
				{
					ros::Rate r(1);

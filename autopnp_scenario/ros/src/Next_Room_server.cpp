...
#include <autopnp_scenario/Next_RoomAction.h>
...
class Next_Room_Server
	{
		protected:
			ros::NodeHandle nh_;
			actionlib::SimpleActionServer<autopnp_scenario::Next_RoomAction> nrs;
			std::string action_name_;
			autopnp_scenario::Next_RoomFeedback feedback_;
			autopnp_scenario::Next_RoomResult result_;
		...
		public:
			...
			void executeCB(const autopnp_scenario::Next_RoomGoalConstPtr &goal)
				{
					ros::Rate r(1);

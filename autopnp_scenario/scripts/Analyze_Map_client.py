...
class AnalyzeMap():
    ...
    def Analyze_Map_client(self):  
        ...
        client = actionlib.SimpleActionClient( 'Analyze_Map', autopnp_scenario.msg.Analyze_MapAction )
               
        cv_image = CvBridge()
        
        goal = autopnp_scenario.msg.Analyze_MapGoal( input_img = cv_image.cv_to_imgmsg( mat , "mono8") , 

...
def random_Location( InputImg , RoomNumber, RoomMinX, RoomMaxX, RoomMinY, RoomMaxY , UnsuccessTime ):  
    ...
    client = actionlib.SimpleActionClient( 'Find_Random_Location', autopnp_scenario.msg.Random_LocationAction )
    ...
    goal = autopnp_scenario.msg.Random_LocationGoal( input_img = InputImg,

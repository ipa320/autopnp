 ...
 *
 * $Id: subscriberNode.c 7805 2014-03-13 09:54:35Z geisinger $
 */

/**
 * \file
 *         Main file of node 'subscriberNode'.
 *
 * \author
...
// PROTECTED REGION ID(SUBSCRIBERNODE_INCLUDES) ENABLED START
 ...
 *             14 | marshaler.configuration[0].in (pnpClient.outManifest)
 *             15 | marshaler.configuration[1].in (pnpClient.outLogoutAcknowledgment)
 *             16 | marshaler.configuration[2].in (pnpClient.outLogoutRequest)
 *             17 | marshaler.configuration[3].in (pnpClient.outRemoveComponentRequest)
 *             18 | udpSend.configuration[0].in (pnpClient.outManifest)
 *             19 | udpSend.configuration[1].in (pnpClient.outLogoutAcknowledgment)
 *             20 | udpSend.configuration[2].in (pnpClient.outLogoutRequest)
 *             21 | udpSend.configuration[3].in (pnpClient.outRemoveComponentRequest)
 */
static xme_core_dataManager_dataPacketId_t ports[22];
...
static xme_core_exec_functionDescriptor_t* subscriberFuncDescs[1] = {NULL};
...
)
{
    ...
    // PROTECTED REGION ID(SUBSCRIBERNODE_XME_INIT) ENABLED START
    ...
    xme_core_node_setNodeName("subscriberNode");
...
{
	//TODO: Remove protected region when issue #3982 has been resolved!
    // PROTECTED REGION ID(SUBSCRIBERNODE_XME_FINI) ENABLED START
...
pnpInit(void)
{
    ...
    announceComponentPortsToPnpClient((xme_core_component_t)129); // Component 'subscriber' of type 'subscriber'
...
configureSchedule(void)
{
    ...
    // Component 'subscriber' function 'receive'
    if (NULL != subscriberFuncDescs[0])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(subscriberFuncDescs[0], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    ...
    if (NULL != subscriberFuncDescs[0])
    {
        // Add function 'receive' of component instance 'subscriber' of type 'subscriber' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            subscriberFuncDescs[0]->componentId,
            subscriberFuncDescs[0]->functionId,
            subscriberFuncDescs[0]->taskArgs,
            xme_hal_time_timeIntervalFromMilliseconds(85ull),
            xme_hal_time_timeIntervalFromMilliseconds(10ull),
            1,
            0,
            true
...
createComponentInstances(void)
{
    ...
    // Create statically configured component instance 'subscriber' of type 'subscriber'
    {
        xme_core_nodeMgr_compRep_componentBuilder_t* builder = NULL;
        xme_core_nodeMgr_compRep_componentHandle_t componentHandle;

        builder = xme_core_nodeMgr_compRep_createBuilder(XME_CORE_NODE_LOCAL_NODE_ID, (xme_core_componentType_t)4098);
        XME_CHECK_MSG(NULL != builder, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'subscriber' of type 'subscriber' failed. Builder could not be created.\n", __FILE__, __LINE__);
        xme_core_nodeMgr_compRep_builderSetComponentID(builder, (xme_core_component_t)129);
        status = xme_core_nodeMgr_compRep_build(builder, &componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'subscriber' of type 'subscriber' failed. Building of component failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_setStateToAnnounced(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'subscriber' of type 'subscriber' failed. Setting state to ANNOUNCED failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_createAndRegisterComponent(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'subscriber' of type 'subscriber' failed. Registration and port allocation failed.\n", __FILE__, __LINE__);

        ports[6] = getDataPacketID((xme_core_component_t)129, 0);
        
        subscriberFuncDescs[0] = getFunctionDescriptor((xme_core_component_t)129, 0);
    }
...
createWaypoints(void)
{
...

    {
        ...
        if (NULL != marshalerWaypointDescriptor)
        {
            ...
            (
                marshalerWaypointDescriptor,
                &ports[14], // marshaler.configuration[0].in (pnpClient.outManifest)
                1,
            ...
            (
                marshalerWaypointDescriptor,
                &ports[15], // marshaler.configuration[1].in (pnpClient.outLogoutAcknowledgment)
                1,
            ...
            (
                marshalerWaypointDescriptor,
                &ports[16], // marshaler.configuration[2].in (pnpClient.outLogoutRequest)
                1,
            ...
            (
                marshalerWaypointDescriptor,
                &ports[17], // marshaler.configuration[3].in (pnpClient.outRemoveComponentRequest)
                1,
        ...
        {
            {
                ...
                (
                    udpSendWaypointDescriptor,
                    &ports[18], // udpSend.configuration[0].in (pnpClient.outManifest)
                    key,
                    "127.0.0.1",
                    33221,
                    XME_CORE_TOPIC_PNP_COMPONENTINSTANCEMANIFEST,
            ...
            }
            {
                ...
                (
                    udpSendWaypointDescriptor,
                    &ports[19], // udpSend.configuration[1].in (pnpClient.outLogoutAcknowledgment)
                    key,
                    "127.0.0.1",
                    33221,
                    XME_CORE_TOPIC_PNP_LOGOUTACKNOWLEDGMENT,
            ...
            }
            {
                ...
                (
                    udpSendWaypointDescriptor,
                    &ports[20], // udpSend.configuration[2].in (pnpClient.outLogoutRequest)
                    key,
                    "127.0.0.1",
                    33221,
                    XME_CORE_TOPIC_PNP_LOGOUTREQUEST,
            ...
            }
            {
                ...
                (
                    udpSendWaypointDescriptor,
                    &ports[21], // udpSend.configuration[3].in (pnpClient.outRemoveComponentRequest)
                    key,
                    "127.0.0.1",
                    33221,
                    XME_CORE_TOPIC_PNP_REMOVECOMPONENTREQUEST,
...
addDataPacketTransferEntries(void)
{
    ...
    status = xme_core_broker_addDataPacketTransferEntry(ports[2], ports[14]); // pnpClient.outManifest -> marshaler.configuration[0].in (pnpClient.outManifest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[2], ports[14], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[3], ports[15]); // pnpClient.outLogoutAcknowledgment -> marshaler.configuration[1].in (pnpClient.outLogoutAcknowledgment)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[3], ports[15], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[4], ports[16]); // pnpClient.outLogoutRequest -> marshaler.configuration[2].in (pnpClient.outLogoutRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[4], ports[16], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[5], ports[17]); // pnpClient.outRemoveComponentRequest -> marshaler.configuration[3].in (pnpClient.outRemoveComponentRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[5], ports[17], status);
    ...
    status = xme_core_broker_addDataPacketTransferEntry(ports[10], ports[18]); // marshaler.configuration[0].out (pnpClient.outManifest) -> udpSend.configuration[0].in (pnpClient.outManifest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[10], ports[18], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[11], ports[19]); // marshaler.configuration[1].out (pnpClient.outLogoutAcknowledgment) -> udpSend.configuration[1].in (pnpClient.outLogoutAcknowledgment)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[11], ports[19], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[12], ports[20]); // marshaler.configuration[2].out (pnpClient.outLogoutRequest) -> udpSend.configuration[2].in (pnpClient.outLogoutRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[12], ports[20], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[13], ports[21]); // marshaler.configuration[3].out (pnpClient.outRemoveComponentRequest) -> udpSend.configuration[3].in (pnpClient.outRemoveComponentRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[13], ports[21], status);
...
main(int argc, char* argv[])
{
    ...
    xme_hal_env_setConsoleTitle("subscriberNode");
    ...
    // PROTECTED REGION ID(SUBSCRIBERNODE_MAIN_BEFORE_COMPONENT_CREATION) ENABLED START
    ...
    // PROTECTED REGION ID(SUBSCRIBERNODE_MAIN_RUN_BEFORE) ENABLED START
    ...
    // PROTECTED REGION ID(SUBSCRIBERNODE_MAIN_RUN_AFTER) ENABLED START
    ...
    XME_LOG(XME_LOG_NOTE, "Node subscriberNode (nodeID %d) has shut down.\n", xme_core_node_getCurrentNodeId());

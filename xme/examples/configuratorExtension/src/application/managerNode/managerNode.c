 ...
 *
 * $Id: managerNode.c 7805 2014-03-13 09:54:35Z geisinger $
 */

/**
 * \file
 *         Main file of node 'managerNode'.
 *
 * \author
...
// PROTECTED REGION ID(MANAGERNODE_INCLUDES) ENABLED START
 ...
 *             19 | demarshaler.configuration[0].out (pnpManager.inComponentInstanceManifest)
 *             20 | demarshaler.configuration[1].out (pnpManager.inLogoutRequest)
 *             21 | demarshaler.configuration[2].out (pnpManager.inLogoutAcknowledgment)
 *             22 | demarshaler.configuration[3].out (pnpManager.inRemoveComponentRequest)
 *             23 | demarshaler.configuration[4].out (pnpManager.inRemoveComponentRequest)
 *             24 | demarshaler.configuration[5].out (loginManager.inLoginRequest)
 *             25 | demarshaler.configuration[6].out (pnpClient.inGraph)
 *             26 | demarshaler.configuration[0].in (pnpManager.inComponentInstanceManifest)
 *             27 | demarshaler.configuration[1].in (pnpManager.inLogoutRequest)
 *             28 | demarshaler.configuration[2].in (pnpManager.inLogoutAcknowledgment)
 *             29 | demarshaler.configuration[3].in (pnpManager.inRemoveComponentRequest)
 *             30 | demarshaler.configuration[4].in (pnpManager.inRemoveComponentRequest)
 *             31 | demarshaler.configuration[5].in (loginManager.inLoginRequest)
 *             32 | demarshaler.configuration[6].in (pnpClient.inGraph)
 *             33 | udpReceive.configuration[0].out (pnpManager.inComponentInstanceManifest)
 *             34 | udpReceive.configuration[1].out (pnpManager.inLogoutRequest)
 *             35 | udpReceive.configuration[2].out (pnpManager.inLogoutAcknowledgment)
 *             36 | udpReceive.configuration[3].out (pnpManager.inRemoveComponentRequest)
 *             37 | udpReceive.configuration[4].out (pnpManager.inRemoveComponentRequest)
 *             38 | udpReceive.configuration[5].out (loginManager.inLoginRequest)
 *             39 | udpReceive.configuration[6].out (pnpClient.inGraph)
 *             40 | marshaler.configuration[0].out (pnpManager.outRuntimeGraph)
 *             41 | marshaler.configuration[0].in (pnpManager.outRuntimeGraph)
 *             42 | udpSend.configuration[0].in (pnpManager.outRuntimeGraph)
 *             43 | udpSend.configuration[1].in (pnpManager.outRuntimeGraph)
 */
static xme_core_dataManager_dataPacketId_t ports[44];

/**
 * \brief Buffers required by UdpReceiveWaypoint.
 */
static void* udpReceiveBuffers[7];
/**
...
static xme_core_exec_functionDescriptor_t* pnpControlUIFuncDescs[1] = {NULL};

static xme_core_exec_functionDescriptor_t* demarshalerWaypointDescriptor = NULL;
static xme_wp_waypoint_instanceId_t demarshalerWaypointInstanceIds[7] = { XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID };
static xme_core_exec_functionDescriptor_t* udpReceiveWaypointDescriptor = NULL;
static xme_wp_waypoint_instanceId_t udpReceiveWaypointInstanceIds[7] = { XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID };
...
)
{
    ...
    // PROTECTED REGION ID(MANAGERNODE_XME_INIT) ENABLED START
    ...
    xme_core_node_setNodeName("managerNode");
...
{
	//TODO: Remove protected region when issue #3982 has been resolved!
    // PROTECTED REGION ID(MANAGERNODE_XME_FINI) ENABLED START
...
pnpInit(void)
{
    ...
    announceComponentPortsToPnpClient((xme_core_component_t)131); // Component 'pnpControlUI' of type 'pnpControlUI'

    // Register all nodes and their interfaces

    // Register node 'managerNode'
    {
        // FIXME: Self registration should be made using PnPManager.
        status = xme_core_directory_nodeRegistryController_registerNode((xme_core_node_nodeId_t)1, "managerNode", (xme_core_node_guid_t)1);
        XME_CHECK_MSG
        (
    ...
    // Register node 'publisherNode'
    {
        // FIXME: Self registration should be made using PnPManager.
        status = xme_core_directory_nodeRegistryController_registerNode((xme_core_node_nodeId_t)2, "publisherNode", (xme_core_node_guid_t)2);
        XME_CHECK_MSG
        (
            XME_STATUS_SUCCESS == status,
            XME_STATUS_INTERNAL_ERROR,
    ...
    // Register node 'subscriberNode'
    {
        // FIXME: Self registration should be made using PnPManager.
        status = xme_core_directory_nodeRegistryController_registerNode((xme_core_node_nodeId_t)3, "subscriberNode", (xme_core_node_guid_t)3);
        XME_CHECK_MSG
        (
            XME_STATUS_SUCCESS == status,
            XME_STATUS_INTERNAL_ERROR,
    ...
    (
        ...
        (xme_core_component_t)3, // from node 'managerNode' component 'pnpManager'
        5, // publication 'outRuntimeGraph'
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)4, // to node 'managerNode' component 'pnpClient'
    ...
    (
        ...
        (xme_core_component_t)4, // to node 'publisherNode' component 'pnpClient'
        1, // subscription 'inGraph'
        (xme_core_channelId_t)10
    );
    if (XME_STATUS_SUCCESS != status)
    ...
    (
        ...
        (xme_core_component_t)4, // to node 'subscriberNode' component 'pnpClient'
        1, // subscription 'inGraph'
        (xme_core_channelId_t)10
    );
    if (XME_STATUS_SUCCESS != status)
    ...
    (
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)1, // from node 'managerNode' component 'loginManager'
        3, // publication 'outPnPLoginRequest'
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)3, // to node 'managerNode' component 'pnpManager'
    ...
    (
        ...
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)1, // to node 'managerNode' component 'loginManager'
    ...
    (
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)4, // from node 'managerNode' component 'pnpClient'
    ...
    (
        (xme_core_node_nodeId_t)2,
        (xme_core_component_t)4, // from node 'publisherNode' component 'pnpClient'
        2, // publication 'outManifest'
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)3, // to node 'managerNode' component 'pnpManager'
        0, // subscription 'inComponentInstanceManifest'
    ...
    (
        (xme_core_node_nodeId_t)3,
        (xme_core_component_t)4, // from node 'subscriberNode' component 'pnpClient'
        2, // publication 'outManifest'
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)3, // to node 'managerNode' component 'pnpManager'
        0, // subscription 'inComponentInstanceManifest'
    ...
    // Node 'managerNode', component 'loginManager' of type 'loginManager'
    ...
    // Node 'managerNode', component 'pnpClient' of type 'pnpClient'
    status = xme_core_pnp_pnpManager_announcePorts
    (
        (xme_core_node_nodeId_t)1,
    ...
    // Node 'managerNode', component 'pnpControlUI' of type 'pnpControlUI'
    status = xme_core_pnp_pnpManager_announcePorts
    (
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)131,
        (xme_core_componentType_t)4101
    );
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, status, XME_LOG_FATAL, ".\n");

    // Node 'managerNode', component 'pnpManager' of type 'pnpManager'
    status = xme_core_pnp_pnpManager_announcePorts
    (
        (xme_core_node_nodeId_t)1,
    ...
    // Node 'subscriberNode', component 'subscriber' of type 'subscriber'
    {
...
configureSchedule(void)
{
    ...
    // Component 'pnpControlUI' function 'pnpControlUI'
    if (NULL != pnpControlUIFuncDescs[0])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(pnpControlUIFuncDescs[0], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    ...
    if (NULL != demarshalerWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(265ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != loginManagerFuncDescs[1])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(370ull),
            xme_hal_time_timeIntervalFromMilliseconds(100ull),
            1,
            0,
            true
    ...
    if (NULL != pnpClientFuncDescs[0])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(470ull),
            xme_hal_time_timeIntervalFromMilliseconds(10ull),
            1,
            0,
            true
    ...
    if (NULL != udpReceiveWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(480ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != demarshalerWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(485ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != pnpClientFuncDescs[1])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(490ull),
            xme_hal_time_timeIntervalFromMilliseconds(10ull),
            1,
            0,
            true
    ...
    if (NULL != pnpControlUIFuncDescs[0])
    {
        // Add function 'pnpControlUI' of component instance 'pnpControlUI' of type 'pnpControlUI' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            pnpControlUIFuncDescs[0]->componentId,
            pnpControlUIFuncDescs[0]->functionId,
            pnpControlUIFuncDescs[0]->taskArgs,
...
createComponentInstances(void)
{
    ...
    // Create statically configured component instance 'pnpControlUI' of type 'pnpControlUI'
    {
        xme_core_nodeMgr_compRep_componentBuilder_t* builder = NULL;
        xme_core_nodeMgr_compRep_componentHandle_t componentHandle;

        builder = xme_core_nodeMgr_compRep_createBuilder(XME_CORE_NODE_LOCAL_NODE_ID, (xme_core_componentType_t)4101);
        XME_CHECK_MSG(NULL != builder, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'pnpControlUI' of type 'pnpControlUI' failed. Builder could not be created.\n", __FILE__, __LINE__);
        xme_core_nodeMgr_compRep_builderSetComponentID(builder, (xme_core_component_t)131);
        status = xme_core_nodeMgr_compRep_build(builder, &componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'pnpControlUI' of type 'pnpControlUI' failed. Building of component failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_setStateToAnnounced(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'pnpControlUI' of type 'pnpControlUI' failed. Setting state to ANNOUNCED failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_createAndRegisterComponent(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'pnpControlUI' of type 'pnpControlUI' failed. Registration and port allocation failed.\n", __FILE__, __LINE__);

        
        pnpControlUIFuncDescs[0] = getFunctionDescriptor((xme_core_component_t)131, 0);
    }
...
createWaypoints(void)
{
...

    {
        ...
        if (NULL != demarshalerWaypointDescriptor)
        {
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[26], // demarshaler.configuration[0].in (pnpManager.inComponentInstanceManifest)
                1,
                &ports[19], // demarshaler.configuration[0].out (pnpManager.inComponentInstanceManifest)
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[27], // demarshaler.configuration[1].in (pnpManager.inLogoutRequest)
                1,
                &ports[20], // demarshaler.configuration[1].out (pnpManager.inLogoutRequest)
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[28], // demarshaler.configuration[2].in (pnpManager.inLogoutAcknowledgment)
                1,
                &ports[21], // demarshaler.configuration[2].out (pnpManager.inLogoutAcknowledgment)
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[29], // demarshaler.configuration[3].in (pnpManager.inRemoveComponentRequest)
                1,
                &ports[22], // demarshaler.configuration[3].out (pnpManager.inRemoveComponentRequest)
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[30], // demarshaler.configuration[4].in (pnpManager.inRemoveComponentRequest)
                1,
                &ports[23], // demarshaler.configuration[4].out (pnpManager.inRemoveComponentRequest)
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[31], // demarshaler.configuration[5].in (loginManager.inLoginRequest)
                1,
                &ports[24], // demarshaler.configuration[5].out (loginManager.inLoginRequest)
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[32], // demarshaler.configuration[6].in (pnpClient.inGraph)
                1,
                &ports[25], // demarshaler.configuration[6].out (pnpClient.inGraph)
        ...
        {
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[33], // udpReceive.configuration[0].out (pnpManager.inComponentInstanceManifest)
                    key,
                    33221,
                    XME_CORE_TOPIC_PNP_COMPONENTINSTANCEMANIFEST,
                    sizeof(xme_core_topic_pnp_componentInstanceManifest_t),
            ...
            }
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[34], // udpReceive.configuration[1].out (pnpManager.inLogoutRequest)
                    key,
                    33221,
                    XME_CORE_TOPIC_PNP_LOGOUTREQUEST,
                    sizeof(xme_core_topic_pnp_logoutRequest_t),
            ...
            }
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[35], // udpReceive.configuration[2].out (pnpManager.inLogoutAcknowledgment)
                    key,
                    33221,
                    XME_CORE_TOPIC_PNP_LOGOUTACKNOWLEDGMENT,
                    sizeof(xme_core_topic_pnp_logoutAcknowledgment_t),
            ...
            }
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[36], // udpReceive.configuration[3].out (pnpManager.inRemoveComponentRequest)
                    key,
                    33221,
                    XME_CORE_TOPIC_PNP_REMOVECOMPONENTREQUEST,
                    sizeof(xme_core_topic_pnp_removeComponentRequest_t),
            ...
            }
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[37], // udpReceive.configuration[4].out (pnpManager.inRemoveComponentRequest)
                    key,
                    33221,
                    XME_CORE_TOPIC_PNP_REMOVECOMPONENTREQUEST,
                    sizeof(xme_core_topic_pnp_removeComponentRequest_t),
            ...
            }
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[38], // udpReceive.configuration[5].out (loginManager.inLoginRequest)
                    key,
                    33200,
                    XME_CORE_TOPIC_LOGIN_LOGINREQUEST,
                    sizeof(xme_core_topic_login_loginRequest_t),
            ...
            }
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[39], // udpReceive.configuration[6].out (pnpClient.inGraph)
                    key,
                    33221,
                    XME_CORE_TOPIC_PNPMANAGER_RUNTIME_GRAPH_MODEL,
                    sizeof(xme_core_topic_pnpManager_runtime_graph_model_t),
...

    {
        ...
        if (NULL != marshalerWaypointDescriptor)
        {
            ...
            (
                marshalerWaypointDescriptor,
                &ports[41], // marshaler.configuration[0].in (pnpManager.outRuntimeGraph)
                1,
                &ports[40], // marshaler.configuration[0].out (pnpManager.outRuntimeGraph)
        ...
        {
            {
                ...
                (
                    udpSendWaypointDescriptor,
                    &ports[42], // udpSend.configuration[0].in (pnpManager.outRuntimeGraph)
                    key,
                    "127.0.0.1",
                    33222,
                    XME_CORE_TOPIC_PNPMANAGER_RUNTIME_GRAPH_MODEL,
            ...
            }
            {
                ...
                (
                    udpSendWaypointDescriptor,
                    &ports[43], // udpSend.configuration[1].in (pnpManager.outRuntimeGraph)
                    key,
                    "127.0.0.1",
                    33223,
                    XME_CORE_TOPIC_PNPMANAGER_RUNTIME_GRAPH_MODEL,
...
createComponentTypeManifests(void)
{
    ...
    // Create and add manifest for component type 'pnpControlUI' to manifest repository
    {
        xme_core_componentManifest_t componentManifest;

        status = configuratorExtension_adv_pnpControlUI_manifest_createComponentTypeManifest(&componentManifest);

        if (XME_STATUS_SUCCESS != status)
        {
            XME_LOG(XME_LOG_WARNING, "Creation of component type manifest for 'pnpControlUI' failed.\n");
        }
        else
        {
            status = xme_core_manifestRepository_addComponentManifest(&componentManifest, false);
            ...
            if (XME_STATUS_SUCCESS != status)
            {
                XME_LOG(XME_LOG_WARNING, "Addtion of component type manifest to manifest repository failed for 'pnpControlUI'.\n");
            }
        }
    }
...
registerComponentTypesInLoggingEngine(void)
{
    ...
    {
        // Register component type 'pnpControlUI' in logging engine
        status = xme_core_log_registerComponent((xme_core_log_componentID_t) 4101, "pnpControlUI", xme_core_log_getMinimumLogSeverityLevel());
        XME_LOG_IF
        (
            XME_STATUS_SUCCESS != status,
            XME_LOG_WARNING,
...
addDataPacketTransferEntries(void)
{
    ...
    status = xme_core_broker_addDataPacketTransferEntry(ports[16], ports[41]); // pnpManager.outRuntimeGraph -> marshaler.configuration[0].in (pnpManager.outRuntimeGraph)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[16], ports[41], status);
    ...
    status = xme_core_broker_addDataPacketTransferEntry(ports[19], ports[11]); // demarshaler.configuration[0].out (pnpManager.inComponentInstanceManifest) -> pnpManager.inComponentInstanceManifest
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[19], ports[11], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[20], ports[13]); // demarshaler.configuration[1].out (pnpManager.inLogoutRequest) -> pnpManager.inLogoutRequest
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[20], ports[13], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[21], ports[14]); // demarshaler.configuration[2].out (pnpManager.inLogoutAcknowledgment) -> pnpManager.inLogoutAcknowledgment
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[21], ports[14], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[22], ports[15]); // demarshaler.configuration[3].out (pnpManager.inRemoveComponentRequest) -> pnpManager.inRemoveComponentRequest
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[22], ports[15], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[23], ports[15]); // demarshaler.configuration[4].out (pnpManager.inRemoveComponentRequest) -> pnpManager.inRemoveComponentRequest
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[23], ports[15], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[24], ports[0]); // demarshaler.configuration[5].out (loginManager.inLoginRequest) -> loginManager.inLoginRequest
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[24], ports[0], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[25], ports[6]); // demarshaler.configuration[6].out (pnpClient.inGraph) -> pnpClient.inGraph
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[25], ports[6], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[33], ports[26]); // udpReceive.configuration[0].out (pnpManager.inComponentInstanceManifest) -> demarshaler.configuration[0].in (pnpManager.inComponentInstanceManifest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[33], ports[26], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[34], ports[27]); // udpReceive.configuration[1].out (pnpManager.inLogoutRequest) -> demarshaler.configuration[1].in (pnpManager.inLogoutRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[34], ports[27], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[35], ports[28]); // udpReceive.configuration[2].out (pnpManager.inLogoutAcknowledgment) -> demarshaler.configuration[2].in (pnpManager.inLogoutAcknowledgment)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[35], ports[28], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[36], ports[29]); // udpReceive.configuration[3].out (pnpManager.inRemoveComponentRequest) -> demarshaler.configuration[3].in (pnpManager.inRemoveComponentRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[36], ports[29], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[37], ports[30]); // udpReceive.configuration[4].out (pnpManager.inRemoveComponentRequest) -> demarshaler.configuration[4].in (pnpManager.inRemoveComponentRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[37], ports[30], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[38], ports[31]); // udpReceive.configuration[5].out (loginManager.inLoginRequest) -> demarshaler.configuration[5].in (loginManager.inLoginRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[38], ports[31], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[39], ports[32]); // udpReceive.configuration[6].out (pnpClient.inGraph) -> demarshaler.configuration[6].in (pnpClient.inGraph)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[39], ports[32], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[40], ports[42]); // marshaler.configuration[0].out (pnpManager.outRuntimeGraph) -> udpSend.configuration[0].in (pnpManager.outRuntimeGraph)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[40], ports[42], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[40], ports[43]); // marshaler.configuration[0].out (pnpManager.outRuntimeGraph) -> udpSend.configuration[1].in (pnpManager.outRuntimeGraph)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[40], ports[43], status);
...
main(int argc, char* argv[])
{
    ...
    xme_hal_env_setConsoleTitle("managerNode");
    ...
    // PROTECTED REGION ID(MANAGERNODE_MAIN_BEFORE_COMPONENT_CREATION) ENABLED START
    ...
    // PROTECTED REGION ID(MANAGERNODE_MAIN_RUN_AFTER) ENABLED START
    ...
    XME_LOG(XME_LOG_NOTE, "Node managerNode (nodeID %d) has shut down.\n", xme_core_node_getCurrentNodeId());

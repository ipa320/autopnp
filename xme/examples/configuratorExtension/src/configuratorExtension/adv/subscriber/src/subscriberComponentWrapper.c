 ...
 *
 * $Id: subscriberComponentWrapper.c 7769 2014-03-11 15:27:13Z geisinger $
 */
...
static inputPort_t inputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } } // subscriber.in
};
...
configuratorExtension_adv_subscriber_subscriberComponentWrapper_completeReadOperations(void)
{
    ...
    for (inputPortIndex = 0U; inputPortIndex < inputPortCount; inputPortIndex++)
    {
        ...
        (void) configuratorExtension_adv_subscriber_subscriberComponentWrapper_readNextPacket(inputPortIndex);
    }
}
...
)
{
    ...
    inputPortIndex = (uint8_t)CONFIGURATOREXTENSION_ADV_SUBSCRIBER_SUBSCRIBERCOMPONENTWRAPPER_PORT_IN;
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_LOG_ERROR,
            "[subscriberComponentWrapper] CompleteReadOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",

 ...
 *
 * $Id: pnpControlUIFunctionWrapper.c 6351 2014-01-15 16:03:40Z geisinger $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/pnpControlUIFunctionWrapper.h"

#include "../include/pnpControlUIComponentWrapper.h"
#include "../include/pnpControlUIFunction.h"
...
/******************************************************************************/
void
configuratorExtension_adv_pnpControlUI_pnpControlUIFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            configuratorExtension_adv_pnpControlUI_pnpControlUIFunction_step((configuratorExtension_adv_pnpControlUI_pnpControlUIComponent_config_t* const) functionParameter);
        }

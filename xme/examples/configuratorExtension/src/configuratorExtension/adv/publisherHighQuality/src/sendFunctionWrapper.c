 ...
 *
 * $Id: sendFunctionWrapper.c 6351 2014-01-15 16:03:40Z geisinger $
 */
...
/******************************************************************************/
void
configuratorExtension_adv_publisherHighQuality_sendFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            configuratorExtension_adv_publisherHighQuality_sendFunction_step((configuratorExtension_adv_publisherHighQuality_publisherHighQualityComponent_config_t* const) functionParameter);
            configuratorExtension_adv_publisherHighQuality_publisherHighQualityComponentWrapper_completeWriteOperations();
        }

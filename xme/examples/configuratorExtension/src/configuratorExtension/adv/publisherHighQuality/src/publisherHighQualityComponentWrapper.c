 ...
 *
 * $Id: publisherHighQualityComponentWrapper.c 7774 2014-03-11 17:38:48Z geisinger $
 */
...
static outputPort_t outputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } } // publisherHighQuality.out
};
...
configuratorExtension_adv_publisherHighQuality_publisherHighQualityComponentWrapper_completeWriteOperations(void)
{
    ...
    for (outputPortIndex = 0U; outputPortIndex < outputPortCount; outputPortIndex++)
    {
        ...
        (void) configuratorExtension_adv_publisherHighQuality_publisherHighQualityComponentWrapper_writeNextPacket(outputPortIndex);
    }
}
...
)
{
    ...
    outputPortIndex = ((uint8_t)CONFIGURATOREXTENSION_ADV_PUBLISHERHIGHQUALITY_PUBLISHERHIGHQUALITYCOMPONENTWRAPPER_PORT_OUT);
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[publisherHighQualityComponentWrapper] writePortOut(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    else
    {
        ...
        (
            XME_LOG_ERROR,
            "%s:%d configuratorExtension_adv_publisherHighQuality_publisherHighQualityComponentWrapper_writeOutputPortAttribute: Writing to port failed. Data Handler returned error code %d.",
            __FILE__,
            __LINE__,
            status
        );
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_LOG_ERROR,
            "[publisherHighQualityComponentWrapper] CompleteWriteOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",
        ...
        if (XME_STATUS_BUFFER_TOO_SMALL == status)
        {
            ...
            (
                XME_LOG_WARNING,
                "[publisherHighQualityComponentWrapper] Data loss on port (interalPortId: %d, dataPacketId: %d), because of full buffer. Oldest value was overwritten.\n",

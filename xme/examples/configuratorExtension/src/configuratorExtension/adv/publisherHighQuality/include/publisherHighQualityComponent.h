 ...
 *
 * $Id: publisherHighQualityComponent.h 6351 2014-01-15 16:03:40Z geisinger $
 */

/**
 * \file
 *         Header file for publisherHighQuality component.
 *
 * \author
...
#ifndef CONFIGURATOREXTENSION_ADV_PUBLISHERHIGHQUALITY_PUBLISHERHIGHQUALITYCOMPONENT_H
#define CONFIGURATOREXTENSION_ADV_PUBLISHERHIGHQUALITY_PUBLISHERHIGHQUALITYCOMPONENT_H
...
// PROTECTED REGION ID(CONFIGURATOREXTENSION_ADV_PUBLISHERHIGHQUALITY_PUBLISHERHIGHQUALITYCOMPONENT_H_INCLUDES) ENABLED START
...
// PROTECTED REGION ID(CONFIGURATOREXTENSION_ADV_PUBLISHERHIGHQUALITY_PUBLISHERHIGHQUALITYCOMPONENT_H_DEFINES) ENABLED START
...
// PROTECTED REGION ID(CONFIGURATOREXTENSION_ADV_PUBLISHERHIGHQUALITY_PUBLISHERHIGHQUALITYCOMPONENT_H_TYPE_DEFINITIONS) ENABLED START

// PROTECTED REGION END

/**
 * \typedef configuratorExtension_adv_publisherHighQuality_publisherHighQualityComponent_config_t
 *
...
typedef struct
{
    // PROTECTED REGION ID(CONFIGURATOREXTENSION_ADV_PUBLISHERHIGHQUALITY_PUBLISHERHIGHQUALITYCOMPONENT_H_CONFIG) ENABLED START

    char dummy; ///< Dummy field, replace with actual component configuration.

// PROTECTED REGION END
} configuratorExtension_adv_publisherHighQuality_publisherHighQualityComponent_config_t;
...
// PROTECTED REGION ID(CONFIGURATOREXTENSION_ADV_PUBLISHERHIGHQUALITY_PUBLISHERHIGHQUALITYCOMPONENT_H_PROTOTYPES) ENABLED START

// PROTECTED REGION END

XME_EXTERN_C_END

#endif // #ifndef CONFIGURATOREXTENSION_ADV_PUBLISHERHIGHQUALITY_PUBLISHERHIGHQUALITYCOMPONENT_H

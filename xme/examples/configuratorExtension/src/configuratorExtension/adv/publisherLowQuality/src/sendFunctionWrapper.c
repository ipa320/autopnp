...
/******************************************************************************/
void
configuratorExtension_adv_publisherLowQuality_sendFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            configuratorExtension_adv_publisherLowQuality_sendFunction_step((configuratorExtension_adv_publisherLowQuality_publisherLowQualityComponent_config_t* const) functionParameter);
            configuratorExtension_adv_publisherLowQuality_publisherLowQualityComponentWrapper_completeWriteOperations();
        }

 ...
 *
 * $Id: marshaler.c 7685 2014-03-05 15:21:06Z geisinger $
 */
...
)
{
    ...
    topicDataSize = sizeof(configuratorExtension_topic_data_t);
    ...
    // uint8_t topicData.value
    {
        ...
        netValue = (uint8_t)topicData.value;
    ...
    {
        configuratorExtension_attribute_quality_t attributeValue;
        uint8_t marshaledAttribute[4];
        uint8_t* bufferPtr;
        ...
        XME_CHECK(XME_STATUS_SUCCESS == status || XME_STATUS_NO_SUCH_VALUE == status, XME_STATUS_INTERNAL_ERROR);
        XME_CHECK(XME_STATUS_NO_SUCH_VALUE == status || bytesRead == sizeof(configuratorExtension_attribute_quality_t), XME_STATUS_INTERNAL_ERROR);

 ...
 *
 * $Id: demarshaler.c 7617 2014-02-26 22:13:31Z kainz $
 */
...
/**
 * \brief  Performs demarshaling for topic 'device_info'.
 *
...
)
{
    ...
    if (DETECTOR_TOPIC_DEVICE_INFO == topic)
    {
        ...
        buffer = &topicData;
        bufferSize = sizeof(detector_topic_device_info_t);
        
        status = doDemarshalingForDevice_info
        (
            inputPort,
            outputPort,
            &topicData
...
{
    const uint32_t marshaledDataSize = 52;

 ...
 *
 * $Id: operateFunctionWrapper.c 6372 2014-01-17 09:58:50Z kainz $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/operateFunctionWrapper.h"

#include "../include/deviceComponentWrapper.h"
#include "../include/operateFunction.h"
...
/******************************************************************************/
void
detector_adv_device_operateFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            detector_adv_device_operateFunction_step((detector_adv_device_deviceComponent_config_t* const) functionParameter);
            detector_adv_device_deviceComponentWrapper_completeWriteOperations();
        }

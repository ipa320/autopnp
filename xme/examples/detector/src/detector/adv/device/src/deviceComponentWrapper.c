 ...
 *
 * $Id: deviceComponentWrapper.c 7774 2014-03-11 17:38:48Z geisinger $
 */
...
static outputPort_t outputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } } // device.info
};
...
detector_adv_device_deviceComponentWrapper_completeWriteOperations(void)
{
    ...
    for (outputPortIndex = 0U; outputPortIndex < outputPortCount; outputPortIndex++)
    {
        ...
        (void) detector_adv_device_deviceComponentWrapper_writeNextPacket(outputPortIndex);
    }
}
...
)
{
    ...
    outputPortIndex = ((uint8_t)DETECTOR_ADV_DEVICE_DEVICECOMPONENTWRAPPER_PORT_INFO);
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[deviceComponentWrapper] writePortInfo(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    else
    {
        ...
        (
            XME_LOG_ERROR,
            "%s:%d detector_adv_device_deviceComponentWrapper_writeOutputPortAttribute: Writing to port failed. Data Handler returned error code %d.",
            __FILE__,
            __LINE__,
            status
        );
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_LOG_ERROR,
            "[deviceComponentWrapper] CompleteWriteOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",
        ...
        if (XME_STATUS_BUFFER_TOO_SMALL == status)
        {
            ...
            (
                XME_LOG_WARNING,
                "[deviceComponentWrapper] Data loss on port (interalPortId: %d, dataPacketId: %d), because of full buffer. Oldest value was overwritten.\n",

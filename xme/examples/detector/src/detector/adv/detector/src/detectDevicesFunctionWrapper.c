 ...
 *
 * $Id: detectDevicesFunctionWrapper.c 6372 2014-01-17 09:58:50Z kainz $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/detectDevicesFunctionWrapper.h"

#include "../include/detectorComponentWrapper.h"
#include "../include/detectDevicesFunction.h"
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            detector_adv_detector_detectDevicesFunction_step((detector_adv_detector_detectorComponent_config_t* const) functionParameter);
        }

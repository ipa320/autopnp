 ...
 *
 * $Id: printFunctionWrapper.c 6372 2014-01-17 09:58:50Z kainz $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/printFunctionWrapper.h"

#include "../include/loggerComponentWrapper.h"
#include "../include/printFunction.h"
...
/******************************************************************************/
void
detector_adv_logger_printFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            detector_adv_logger_printFunction_step((detector_adv_logger_loggerComponent_config_t* const) functionParameter);
            detector_adv_logger_loggerComponentWrapper_completeReadOperations();
        }

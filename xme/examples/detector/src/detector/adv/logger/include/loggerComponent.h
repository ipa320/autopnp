 ...
 *
 * $Id: loggerComponent.h 6372 2014-01-17 09:58:50Z kainz $
 */

/**
 * \file
 *         Header file for logger component.
 *
 * \author
...
#ifndef DETECTOR_ADV_LOGGER_LOGGERCOMPONENT_H
#define DETECTOR_ADV_LOGGER_LOGGERCOMPONENT_H
...
// PROTECTED REGION ID(DETECTOR_ADV_LOGGER_LOGGERCOMPONENT_H_INCLUDES) ENABLED START
...
// PROTECTED REGION ID(DETECTOR_ADV_LOGGER_LOGGERCOMPONENT_H_DEFINES) ENABLED START
// PROTECTED REGION END
...
// PROTECTED REGION ID(DETECTOR_ADV_LOGGER_LOGGERCOMPONENT_H_TYPE_DEFINITIONS) ENABLED START
// PROTECTED REGION END

/**
 * \typedef detector_adv_logger_loggerComponent_config_t
 *
...
typedef struct
{
    // PROTECTED REGION ID(DETECTOR_ADV_LOGGER_LOGGERCOMPONENT_H_CONFIG) ENABLED START
    char dummy; ///< Dummy field.
    // PROTECTED REGION END
} detector_adv_logger_loggerComponent_config_t;
...
// PROTECTED REGION ID(DETECTOR_ADV_LOGGER_LOGGERCOMPONENT_H_PROTOTYPES) ENABLED START
// PROTECTED REGION END

XME_EXTERN_C_END

#endif // #ifndef DETECTOR_ADV_LOGGER_LOGGERCOMPONENT_H

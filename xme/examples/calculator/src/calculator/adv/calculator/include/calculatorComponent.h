 ...
 *
 * $Id: calculatorComponent.h 6327 2014-01-14 18:18:48Z gulati $
 */

/**
 * \file
 *         Header file for calculator component.
 *
 * \author
...
#ifndef CALCULATOR_ADV_CALCULATOR_CALCULATORCOMPONENT_H
#define CALCULATOR_ADV_CALCULATOR_CALCULATORCOMPONENT_H
...
// PROTECTED REGION ID(CALCULATOR_ADV_CALCULATOR_CALCULATORCOMPONENT_H_INCLUDES) ENABLED START
...
// PROTECTED REGION ID(CALCULATOR_ADV_CALCULATOR_CALCULATORCOMPONENT_H_DEFINES) ENABLED START
...
// PROTECTED REGION ID(CALCULATOR_ADV_CALCULATOR_CALCULATORCOMPONENT_H_TYPE_DEFINITIONS) ENABLED START

// PROTECTED REGION END

/**
 * \typedef calculator_adv_calculator_calculatorComponent_config_t
 *
...
typedef struct
{
    // PROTECTED REGION ID(CALCULATOR_ADV_CALCULATOR_CALCULATORCOMPONENT_H_CONFIG) ENABLED START

    char dummy; ///< Dummy field, replace with actual component configuration.

// PROTECTED REGION END
} calculator_adv_calculator_calculatorComponent_config_t;
...
// PROTECTED REGION ID(CALCULATOR_ADV_CALCULATOR_CALCULATORCOMPONENT_H_PROTOTYPES) ENABLED START

// PROTECTED REGION END

XME_EXTERN_C_END

#endif // #ifndef CALCULATOR_ADV_CALCULATOR_CALCULATORCOMPONENT_H

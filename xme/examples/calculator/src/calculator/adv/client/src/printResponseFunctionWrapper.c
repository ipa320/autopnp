 ...
 *
 * $Id: printResponseFunctionWrapper.c 7769 2014-03-11 15:27:13Z geisinger $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/printResponseFunctionWrapper.h"

#include "../include/clientComponentWrapper.h"
#include "../include/printResponseFunction.h"
...
/******************************************************************************/
void
calculator_adv_client_printResponseFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            calculator_adv_client_printResponseFunction_step((calculator_adv_client_clientComponent_config_t* const) functionParameter);

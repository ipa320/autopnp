 ...
 *
 * $Id: demarshaler.c 7769 2014-03-11 15:27:13Z geisinger $
 */
...
/**
 * \brief  Performs demarshaling for topic 'calculatorResponse'.
 *
 ...
 */
xme_status_t
doDemarshalingForCalculatorResponse
(
    xme_core_dataManager_dataPacketId_t inputPort,
    xme_core_dataManager_dataPacketId_t outputPort,
...
/**
 * \brief  Performs demarshaling for topic 'calculatorRequest'.
 *
 * \param  inputPort Input port where marshaled data is stored.
 * \param  topicData Buffer where marshaled data will be written to.
 *
 ...
 */
xme_status_t
doDemarshalingForCalculatorRequest
(
    xme_core_dataManager_dataPacketId_t inputPort,
    xme_core_dataManager_dataPacketId_t outputPort,
...
)
{
    ...
    if (CALCULATOR_TOPIC_CALCULATORRESPONSE == topic)
    {
        ...
        buffer = &topicData;
        bufferSize = sizeof(calculator_topic_calculatorResponse_t);
        
        status = doDemarshalingForCalculatorResponse
        (
            inputPort,
            outputPort,
            &topicData
    ...
    else if (CALCULATOR_TOPIC_CALCULATORREQUEST == topic)
    {
        ...
        buffer = &topicData;
        bufferSize = sizeof(calculator_topic_calculatorRequest_t);
        
        status = doDemarshalingForCalculatorRequest
        (
            inputPort,
            outputPort,
            &topicData
...
{
    const uint32_t marshaledDataSize = 9;
    unsigned int bytesRead;

 ...
 *
 * $Id: emptyNode.c 7805 2014-03-13 09:54:35Z geisinger $
 */
...
// PROTECTED REGION ID(EMPTYNODE_INCLUDES) ENABLED START
...
static xme_core_exec_functionDescriptor_t* pnpTriggerFuncDescs[1] = {NULL};
...
)
{
    ...
    // PROTECTED REGION ID(EMPTYNODE_XME_INIT) ENABLED START
    ...
    xme_core_node_setNodeName("emptyNode");
...
{
	//TODO: Remove protected region when issue #3982 has been resolved!
    // PROTECTED REGION ID(EMPTYNODE_XME_FINI) ENABLED START
...
pnpInit(void)
{
    ...
    announceComponentPortsToPnpClient((xme_core_component_t)129); // Component 'pnpTrigger' of type 'pnpTrigger'
...
configureSchedule(void)
{
    ...
    // Component 'pnpTrigger' function 'trigger'
    if (NULL != pnpTriggerFuncDescs[0])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(pnpTriggerFuncDescs[0], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    ...
    if (NULL != pnpTriggerFuncDescs[0])
    {
        // Add function 'trigger' of component instance 'pnpTrigger' of type 'pnpTrigger' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            pnpTriggerFuncDescs[0]->componentId,
            pnpTriggerFuncDescs[0]->functionId,
            pnpTriggerFuncDescs[0]->taskArgs,
...
createComponentInstances(void)
{
    ...
    // Create statically configured component instance 'pnpTrigger' of type 'pnpTrigger'
    {
        xme_core_nodeMgr_compRep_componentBuilder_t* builder = NULL;
        xme_core_nodeMgr_compRep_componentHandle_t componentHandle;

        builder = xme_core_nodeMgr_compRep_createBuilder(XME_CORE_NODE_LOCAL_NODE_ID, (xme_core_componentType_t)4364);
        XME_CHECK_MSG(NULL != builder, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'pnpTrigger' of type 'pnpTrigger' failed. Builder could not be created.\n", __FILE__, __LINE__);
        xme_core_nodeMgr_compRep_builderSetComponentID(builder, (xme_core_component_t)129);
        status = xme_core_nodeMgr_compRep_build(builder, &componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'pnpTrigger' of type 'pnpTrigger' failed. Building of component failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_setStateToAnnounced(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'pnpTrigger' of type 'pnpTrigger' failed. Setting state to ANNOUNCED failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_createAndRegisterComponent(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'pnpTrigger' of type 'pnpTrigger' failed. Registration and port allocation failed.\n", __FILE__, __LINE__);

        
        pnpTriggerFuncDescs[0] = getFunctionDescriptor((xme_core_component_t)129, 0);
    }
...
main(int argc, char* argv[])
{
    ...
    xme_hal_env_setConsoleTitle("emptyNode");
    ...
    // PROTECTED REGION ID(EMPTYNODE_MAIN_BEFORE_COMPONENT_CREATION) ENABLED START
    ...
    // PROTECTED REGION ID(EMPTYNODE_MAIN_RUN_BEFORE) ENABLED START
    ...
    // PROTECTED REGION ID(EMPTYNODE_MAIN_RUN_AFTER) ENABLED START
    ...
    XME_LOG(XME_LOG_NOTE, "Node emptyNode (nodeID %d) has shut down.\n", xme_core_node_getCurrentNodeId());

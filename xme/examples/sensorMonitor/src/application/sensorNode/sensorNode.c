 ...
 *
 * $Id: sensorNode.c 7805 2014-03-13 09:54:35Z geisinger $
 */
...
// PROTECTED REGION ID(SENSORNODE_INCLUDES) ENABLED START
 ...
 *              6 | sensorB.sensorValueOut
 *              7 | demarshaler.configuration[0].out (pnpClient.inGraph)
 *              8 | demarshaler.configuration[0].in (pnpClient.inGraph)
 *              9 | udpReceive.configuration[0].out (pnpClient.inGraph)
 *             10 | marshaler.configuration[0].out (pnpClient.outManifest)
 *             11 | marshaler.configuration[1].out (pnpClient.outLogoutAcknowledgment)
 *             12 | marshaler.configuration[2].out (pnpClient.outLogoutRequest)
 *             13 | marshaler.configuration[3].out (pnpClient.outRemoveComponentRequest)
 *             14 | marshaler.configuration[4].out (sensorB.sensorValueOut)
 *             15 | marshaler.configuration[0].in (pnpClient.outManifest)
 *             16 | marshaler.configuration[1].in (pnpClient.outLogoutAcknowledgment)
 *             17 | marshaler.configuration[2].in (pnpClient.outLogoutRequest)
 *             18 | marshaler.configuration[3].in (pnpClient.outRemoveComponentRequest)
 *             19 | marshaler.configuration[4].in (sensorB.sensorValueOut)
 *             20 | udpSend.configuration[0].in (pnpClient.outManifest)
 *             21 | udpSend.configuration[1].in (pnpClient.outLogoutAcknowledgment)
 *             22 | udpSend.configuration[2].in (pnpClient.outLogoutRequest)
 *             23 | udpSend.configuration[3].in (pnpClient.outRemoveComponentRequest)
 *             24 | udpSend.configuration[4].in (sensorB.sensorValueOut)
 */
static xme_core_dataManager_dataPacketId_t ports[25];
 ...
 */
static void* udpSendBuffers[5];
static xme_core_exec_functionDescriptor_t* pnpClientFuncDescs[4] = {NULL, NULL, NULL, NULL};
static xme_core_exec_functionDescriptor_t* sensorBFuncDescs[1] = {NULL};
...
static xme_wp_waypoint_instanceId_t marshalerWaypointInstanceIds[5] = { XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID };
static xme_core_exec_functionDescriptor_t* udpSendWaypointDescriptor = NULL;
static xme_wp_waypoint_instanceId_t udpSendWaypointInstanceIds[5] = { XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID };
...
)
{
    ...
    // PROTECTED REGION ID(SENSORNODE_XME_INIT) ENABLED START
    ...
    xme_core_node_setNodeName("sensorNode");
...
{
	//TODO: Remove protected region when issue #3982 has been resolved!
    // PROTECTED REGION ID(SENSORNODE_XME_FINI) ENABLED START
...
pnpInit(void)
{
    ...
    announceComponentPortsToPnpClient((xme_core_component_t)129); // Component 'sensorB' of type 'sensorB'
...
configureSchedule(void)
{
    ...
    // Component 'sensorB' function 'readSensorValue'
    if (NULL != sensorBFuncDescs[0])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(sensorBFuncDescs[0], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    ...
    if (NULL != sensorBFuncDescs[0])
    {
        // Add function 'readSensorValue' of component instance 'sensorB' of type 'sensorB' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            sensorBFuncDescs[0]->componentId,
            sensorBFuncDescs[0]->functionId,
            sensorBFuncDescs[0]->taskArgs,
    ...
    if (NULL != marshalerWaypointDescriptor)
    {
        // Add marshaler waypoint configuration for component port 'sensorB.sensorValueOut'to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            marshalerWaypointDescriptor->componentId,
            marshalerWaypointDescriptor->functionId,
            (void *)(uintptr_t)marshalerWaypointInstanceIds[4],
            xme_hal_time_timeIntervalFromMilliseconds(335ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != udpSendWaypointDescriptor)
    {
        // Add udpsend waypoint configuration for component port 'sensorB.sensorValueOut'to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            udpSendWaypointDescriptor->componentId,
            udpSendWaypointDescriptor->functionId,
            (void *)(uintptr_t)udpSendWaypointInstanceIds[4],
            xme_hal_time_timeIntervalFromMilliseconds(340ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != pnpClientFuncDescs[0])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(345ull),
            xme_hal_time_timeIntervalFromMilliseconds(10ull),
            1,
            0,
            true
    ...
    if (NULL != marshalerWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(355ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != udpSendWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(360ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != udpReceiveWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(365ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != pnpClientFuncDescs[1])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(375ull),
            xme_hal_time_timeIntervalFromMilliseconds(10ull),
            1,
            0,
            true
    ...
    if (NULL != marshalerWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(385ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != udpSendWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(390ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
...
createComponentInstances(void)
{
    ...
    // Create statically configured component instance 'sensorB' of type 'sensorB'
    {
        xme_core_nodeMgr_compRep_componentBuilder_t* builder = NULL;
        xme_core_nodeMgr_compRep_componentHandle_t componentHandle;

        builder = xme_core_nodeMgr_compRep_createBuilder(XME_CORE_NODE_LOCAL_NODE_ID, (xme_core_componentType_t)4354);
        XME_CHECK_MSG(NULL != builder, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'sensorB' of type 'sensorB' failed. Builder could not be created.\n", __FILE__, __LINE__);
        xme_core_nodeMgr_compRep_builderSetComponentID(builder, (xme_core_component_t)129);
        status = xme_core_nodeMgr_compRep_build(builder, &componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'sensorB' of type 'sensorB' failed. Building of component failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_setStateToAnnounced(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'sensorB' of type 'sensorB' failed. Setting state to ANNOUNCED failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_createAndRegisterComponent(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'sensorB' of type 'sensorB' failed. Registration and port allocation failed.\n", __FILE__, __LINE__);

        ports[6] = getDataPacketID((xme_core_component_t)129, 0);
        
        sensorBFuncDescs[0] = getFunctionDescriptor((xme_core_component_t)129, 0);
    }
...
createWaypoints(void)
{
...

    {
        ...
        if (NULL != demarshalerWaypointDescriptor)
        {
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[8], // demarshaler.configuration[0].in (pnpClient.inGraph)
                1,
                &ports[7], // demarshaler.configuration[0].out (pnpClient.inGraph)
        ...
        {
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[9], // udpReceive.configuration[0].out (pnpClient.inGraph)
                    key,
                    33222,
                    XME_CORE_TOPIC_PNPMANAGER_RUNTIME_GRAPH_MODEL,
                    sizeof(xme_core_topic_pnpManager_runtime_graph_model_t),
...

    {
        ...
        if (NULL != marshalerWaypointDescriptor)
        {
            ...
            (
                marshalerWaypointDescriptor,
                &ports[15], // marshaler.configuration[0].in (pnpClient.outManifest)
                1,
                &ports[10], // marshaler.configuration[0].out (pnpClient.outManifest)
            ...
            (
                marshalerWaypointDescriptor,
                &ports[16], // marshaler.configuration[1].in (pnpClient.outLogoutAcknowledgment)
                1,
                &ports[11], // marshaler.configuration[1].out (pnpClient.outLogoutAcknowledgment)
            ...
            (
                marshalerWaypointDescriptor,
                &ports[17], // marshaler.configuration[2].in (pnpClient.outLogoutRequest)
                1,
                &ports[12], // marshaler.configuration[2].out (pnpClient.outLogoutRequest)
            ...
            (
                marshalerWaypointDescriptor,
                &ports[18], // marshaler.configuration[3].in (pnpClient.outRemoveComponentRequest)
                1,
                &ports[13], // marshaler.configuration[3].out (pnpClient.outRemoveComponentRequest)
            ...
            (
                marshalerWaypointDescriptor,
                &ports[19], // marshaler.configuration[4].in (sensorB.sensorValueOut)
                1,
                &ports[14], // marshaler.configuration[4].out (sensorB.sensorValueOut)
                &marshalerWaypointInstanceIds[4],
        ...
        {
            {
                ...
                (
                    udpSendWaypointDescriptor,
                    &ports[20], // udpSend.configuration[0].in (pnpClient.outManifest)
                    key,
                    "127.0.0.1",
                    33221,
                    XME_CORE_TOPIC_PNP_COMPONENTINSTANCEMANIFEST,
            ...
            }
            {
                ...
                (
                    udpSendWaypointDescriptor,
                    &ports[21], // udpSend.configuration[1].in (pnpClient.outLogoutAcknowledgment)
                    key,
                    "127.0.0.1",
                    33221,
                    XME_CORE_TOPIC_PNP_LOGOUTACKNOWLEDGMENT,
            ...
            }
            {
                ...
                (
                    udpSendWaypointDescriptor,
                    &ports[22], // udpSend.configuration[2].in (pnpClient.outLogoutRequest)
                    key,
                    "127.0.0.1",
                    33221,
                    XME_CORE_TOPIC_PNP_LOGOUTREQUEST,
            ...
            }
            {
                ...
                (
                    udpSendWaypointDescriptor,
                    &ports[23], // udpSend.configuration[3].in (pnpClient.outRemoveComponentRequest)
                    key,
                    "127.0.0.1",
                    33221,
                    XME_CORE_TOPIC_PNP_REMOVECOMPONENTREQUEST,
            ...
            }
            {
                ...
                (
                    udpSendWaypointDescriptor,
                    &ports[24], // udpSend.configuration[4].in (sensorB.sensorValueOut)
                    key,
                    "127.0.0.1",
                    33221,
                    SENSORMONITOR_TOPIC_SENSORDATA,
                    sizeof(sensorMonitor_topic_sensorData_t),
                    &udpSendWaypointInstanceIds[4],
                    &udpSendBuffers[4],
                    false
                );
            }
...
addDataPacketTransferEntries(void)
{
    ...
    status = xme_core_broker_addDataPacketTransferEntry(ports[2], ports[15]); // pnpClient.outManifest -> marshaler.configuration[0].in (pnpClient.outManifest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[2], ports[15], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[3], ports[16]); // pnpClient.outLogoutAcknowledgment -> marshaler.configuration[1].in (pnpClient.outLogoutAcknowledgment)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[3], ports[16], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[4], ports[17]); // pnpClient.outLogoutRequest -> marshaler.configuration[2].in (pnpClient.outLogoutRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[4], ports[17], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[5], ports[18]); // pnpClient.outRemoveComponentRequest -> marshaler.configuration[3].in (pnpClient.outRemoveComponentRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[5], ports[18], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[6], ports[19]); // sensorB.sensorValueOut -> marshaler.configuration[4].in (sensorB.sensorValueOut)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[6], ports[19], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[7], ports[1]); // demarshaler.configuration[0].out (pnpClient.inGraph) -> pnpClient.inGraph
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[7], ports[1], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[9], ports[8]); // udpReceive.configuration[0].out (pnpClient.inGraph) -> demarshaler.configuration[0].in (pnpClient.inGraph)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[9], ports[8], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[10], ports[20]); // marshaler.configuration[0].out (pnpClient.outManifest) -> udpSend.configuration[0].in (pnpClient.outManifest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[10], ports[20], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[11], ports[21]); // marshaler.configuration[1].out (pnpClient.outLogoutAcknowledgment) -> udpSend.configuration[1].in (pnpClient.outLogoutAcknowledgment)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[11], ports[21], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[12], ports[22]); // marshaler.configuration[2].out (pnpClient.outLogoutRequest) -> udpSend.configuration[2].in (pnpClient.outLogoutRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[12], ports[22], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[13], ports[23]); // marshaler.configuration[3].out (pnpClient.outRemoveComponentRequest) -> udpSend.configuration[3].in (pnpClient.outRemoveComponentRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[13], ports[23], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[14], ports[24]); // marshaler.configuration[4].out (sensorB.sensorValueOut) -> udpSend.configuration[4].in (sensorB.sensorValueOut)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[14], ports[24], status);
...
main(int argc, char* argv[])
{
    ...
    xme_hal_env_setConsoleTitle("sensorNode");
    ...
    // PROTECTED REGION ID(SENSORNODE_MAIN_BEFORE_COMPONENT_CREATION) ENABLED START
    ...
    // PROTECTED REGION ID(SENSORNODE_MAIN_RUN_BEFORE) ENABLED START
    ...
    // PROTECTED REGION ID(SENSORNODE_MAIN_RUN_AFTER) ENABLED START
    ...
    XME_LOG(XME_LOG_NOTE, "Node sensorNode (nodeID %d) has shut down.\n", xme_core_node_getCurrentNodeId());

 ...
 *
 * $Id: pnpTriggerComponent.h 6326 2014-01-14 18:08:11Z gulati $
 */

/**
 * \file
 *         Header file for pnpTrigger component.
 *
 * \author
...
#ifndef SENSORMONITOR_ADV_PNPTRIGGER_PNPTRIGGERCOMPONENT_H
#define SENSORMONITOR_ADV_PNPTRIGGER_PNPTRIGGERCOMPONENT_H
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_PNPTRIGGER_PNPTRIGGERCOMPONENT_H_INCLUDES) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_PNPTRIGGER_PNPTRIGGERCOMPONENT_H_DEFINES) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_PNPTRIGGER_PNPTRIGGERCOMPONENT_H_TYPE_DEFINITIONS) ENABLED START

// PROTECTED REGION END

/**
 * \typedef sensorMonitor_adv_pnpTrigger_pnpTriggerComponent_config_t
 *
...
typedef struct
{
    // PROTECTED REGION ID(SENSORMONITOR_ADV_PNPTRIGGER_PNPTRIGGERCOMPONENT_H_CONFIG) ENABLED START

    char dummy; ///< Dummy field, replace with actual component configuration.

// PROTECTED REGION END
} sensorMonitor_adv_pnpTrigger_pnpTriggerComponent_config_t;
 ...
 */
xme_status_t
sensorMonitor_adv_pnpTrigger_pnpTriggerComponent_init
(
    sensorMonitor_adv_pnpTrigger_pnpTriggerComponent_config_t* const config,
 ...
 */
void
sensorMonitor_adv_pnpTrigger_pnpTriggerComponent_fini
(
    sensorMonitor_adv_pnpTrigger_pnpTriggerComponent_config_t* const config
);

// PROTECTED REGION ID(SENSORMONITOR_ADV_PNPTRIGGER_PNPTRIGGERCOMPONENT_H_PROTOTYPES) ENABLED START

// PROTECTED REGION END

XME_EXTERN_C_END

#endif // #ifndef SENSORMONITOR_ADV_PNPTRIGGER_PNPTRIGGERCOMPONENT_H

...
/******************************************************************************/
void
sensorMonitor_adv_sensorKB_readSensorValueFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            sensorMonitor_adv_sensorKB_readSensorValueFunction_step((sensorMonitor_adv_sensorKB_sensorKBComponent_config_t* const) functionParameter);
            sensorMonitor_adv_sensorKB_sensorKBComponentWrapper_completeWriteOperations();
        }

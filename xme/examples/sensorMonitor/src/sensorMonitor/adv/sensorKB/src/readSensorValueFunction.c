...
/**
 * \file
 *         Source file for function readSensorValue in component sensorKB.
 *
 * \author
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_SENSORKB_READSENSORVALUEFUNCTION_C_INCLUDES) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_SENSORKB_READSENSORVALUEFUNCTION_C_DEFINITIONS) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_SENSORKB_READSENSORVALUEFUNCTION_C_VARIABLES) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_SENSORKB_READSENSORVALUEFUNCTION_C_PROTOTYPES) ENABLED START
...
{
    // PROTECTED REGION ID(SENSORMONITOR_ADV_SENSORKB_READSENSORVALUEFUNCTION_INITIALIZE_C) ENABLED START
...
)
{
    ...
    {
        // PROTECTED REGION ID(SENSORMONITOR_ADV_SENSORKB_READSENSORVALUEFUNCTION_STEP_C) ENABLED START

        uint64_t sensorValue = sensorMonitor_adv_common_fillSensorValue(componentConfig);

        // Convert from bytes to KB
        uint64_t sensorValueKB = sensorValue / 1000;

        // Print current free space to console
        XME_LOG
        (
            XME_LOG_ALWAYS,
            "Current %s on %s is %" PRIu64 " KB (%" PRIu64 " %s)\n",
        ...
        portSensorValueOutData.sensorValue = sensorValueKB;

        // PROTECTED REGION END
    }
    
    status[0] = sensorMonitor_adv_sensorKB_sensorKBComponentWrapper_writePortSensorValueOut(portSensorValueOutDataPtr);
    
    {
        // PROTECTED REGION ID(SENSORMONITOR_ADV_SENSORKB_READSENSORVALUEFUNCTION_STEP_2_C) ENABLED START
...
{
    // PROTECTED REGION ID(SENSORMONITOR_ADV_SENSORKB_READSENSORVALUEFUNCTION_TERMINATE_C) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_SENSORKB_READSENSORVALUEFUNCTION_IMPLEMENTATION_C) ENABLED START

 ...
 *
 * $Id: triggerFunctionWrapper.c 6326 2014-01-14 18:08:11Z gulati $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/triggerFunctionWrapper.h"

#include "../include/logoutTriggerComponentWrapper.h"
#include "../include/triggerFunction.h"
...
/******************************************************************************/
void
sensorMonitor_adv_logoutTrigger_triggerFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            sensorMonitor_adv_logoutTrigger_triggerFunction_step((sensorMonitor_adv_logoutTrigger_logoutTriggerComponent_config_t* const) functionParameter);
        }

 ...
 *
 * $Id: logoutTriggerComponent.h 6326 2014-01-14 18:08:11Z gulati $
 */

/**
 * \file
 *         Header file for logoutTrigger component.
 *
 * \author
...
#ifndef SENSORMONITOR_ADV_LOGOUTTRIGGER_LOGOUTTRIGGERCOMPONENT_H
#define SENSORMONITOR_ADV_LOGOUTTRIGGER_LOGOUTTRIGGERCOMPONENT_H
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_LOGOUTTRIGGER_LOGOUTTRIGGERCOMPONENT_H_INCLUDES) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_LOGOUTTRIGGER_LOGOUTTRIGGERCOMPONENT_H_DEFINES) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_LOGOUTTRIGGER_LOGOUTTRIGGERCOMPONENT_H_TYPE_DEFINITIONS) ENABLED START

// PROTECTED REGION END

/**
 * \typedef sensorMonitor_adv_logoutTrigger_logoutTriggerComponent_config_t
 *
...
typedef struct
{
    // PROTECTED REGION ID(SENSORMONITOR_ADV_LOGOUTTRIGGER_LOGOUTTRIGGERCOMPONENT_H_CONFIG) ENABLED START

    char dummy; ///< Dummy field, replace with actual component configuration.

// PROTECTED REGION END
} sensorMonitor_adv_logoutTrigger_logoutTriggerComponent_config_t;
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_LOGOUTTRIGGER_LOGOUTTRIGGERCOMPONENT_H_PROTOTYPES) ENABLED START

// PROTECTED REGION END

XME_EXTERN_C_END

#endif // #ifndef SENSORMONITOR_ADV_LOGOUTTRIGGER_LOGOUTTRIGGERCOMPONENT_H

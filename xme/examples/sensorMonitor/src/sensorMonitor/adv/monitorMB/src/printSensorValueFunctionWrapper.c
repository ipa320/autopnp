...
/******************************************************************************/
void
sensorMonitor_adv_monitorMB_printSensorValueFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            sensorMonitor_adv_monitorMB_printSensorValueFunction_step((sensorMonitor_adv_monitorMB_monitorMBComponent_config_t* const) functionParameter);
            sensorMonitor_adv_monitorMB_monitorMBComponentWrapper_completeReadOperations();
        }

 ...
 *
 * $Id: monitorMBComponentWrapper.h 7769 2014-03-11 15:27:13Z geisinger $
 */
...
#ifndef SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENTWRAPPER_H
#define SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENTWRAPPER_H
...
/**
 * \enum sensorMonitor_adv_monitorMB_monitorMBComponentWrapper_internalFunctionId_e
 *
 * \brief Values for identifying functions of monitorMB component.
 */
enum sensorMonitor_adv_monitorMB_monitorMBComponentWrapper_internalFunctionId_e
{
    SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENTWRAPPER_FUNCTION_PRINTSENSORVALUE = 0  ///< Function 'printSensorValue'
};

/**
 * \enum sensorMonitor_adv_monitorMB_monitorMBComponentWrapper_internalPortId_e
 *
 * \brief Values for sensorMonitor_adv_monitorMB_monitorMBComponentWrapper_internalPortId_t.
 */
enum sensorMonitor_adv_monitorMB_monitorMBComponentWrapper_internalPortId_e
{
    SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENTWRAPPER_PORT_SENSORVALUEIN = 0  ///< Port 'sensorValueIn'
};

/**
 * \typedef sensorMonitor_adv_monitorMB_monitorMBComponentWrapper_internalPortId_t
 *
 * \brief Defines internal port ids of component 'monitorMB'.
 *
 * \details These can be used when calling the sensorMonitor_adv_monitorMB_monitorMBComponentWrapper_receivePort function.
 *          For the definition of possible values, see enum sensorMonitor_adv_monitorMB_monitorMBComponentWrapper_internalPortId_e.
 */
typedef uint8_t sensorMonitor_adv_monitorMB_monitorMBComponentWrapper_internalPortId_t;
 ...
 *        For the ids of the individual ports, see the definition of sensorMonitor_adv_monitorMB_monitorMBComponentWrapper_internalPortId_t.
 *
...
#endif // #ifndef SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENTWRAPPER_H

 ...
 *
 * $Id: monitorMBComponent.h 6326 2014-01-14 18:08:11Z gulati $
 */

/**
 * \file
 *         Header file for monitorMB component.
 *
 * \author
...
#ifndef SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENT_H
#define SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENT_H
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENT_H_INCLUDES) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENT_H_DEFINES) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENT_H_TYPE_DEFINITIONS) ENABLED START

// PROTECTED REGION END

/**
 * \typedef sensorMonitor_adv_monitorMB_monitorMBComponent_config_t
 *
...
typedef struct
{
    // PROTECTED REGION ID(SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENT_H_CONFIG) ENABLED START

    char dummy; ///< Dummy field, replace with actual component configuration.

// PROTECTED REGION END
} sensorMonitor_adv_monitorMB_monitorMBComponent_config_t;
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENT_H_PROTOTYPES) ENABLED START

// PROTECTED REGION END

XME_EXTERN_C_END

#endif // #ifndef SENSORMONITOR_ADV_MONITORMB_MONITORMBCOMPONENT_H

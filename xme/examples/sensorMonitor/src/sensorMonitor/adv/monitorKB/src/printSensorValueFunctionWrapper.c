 ...
 *
 * $Id: printSensorValueFunctionWrapper.c 6326 2014-01-14 18:08:11Z gulati $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/printSensorValueFunctionWrapper.h"

#include "../include/monitorKBComponentWrapper.h"
#include "../include/printSensorValueFunction.h"
...
/******************************************************************************/
void
sensorMonitor_adv_monitorKB_printSensorValueFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            sensorMonitor_adv_monitorKB_printSensorValueFunction_step((sensorMonitor_adv_monitorKB_monitorKBComponent_config_t* const) functionParameter);
            sensorMonitor_adv_monitorKB_monitorKBComponentWrapper_completeReadOperations();
        }

 ...
 *
 * $Id: monitorKBComponentWrapper.c 7769 2014-03-11 15:27:13Z geisinger $
 */
...
static inputPort_t inputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } } // monitorKB.sensorValueIn
};
...
sensorMonitor_adv_monitorKB_monitorKBComponentWrapper_completeReadOperations(void)
{
    ...
    for (inputPortIndex = 0U; inputPortIndex < inputPortCount; inputPortIndex++)
    {
        ...
        (void) sensorMonitor_adv_monitorKB_monitorKBComponentWrapper_readNextPacket(inputPortIndex);
    }
}
...
)
{
    ...
    inputPortIndex = (uint8_t)SENSORMONITOR_ADV_MONITORKB_MONITORKBCOMPONENTWRAPPER_PORT_SENSORVALUEIN;
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_LOG_ERROR,
            "[monitorKBComponentWrapper] CompleteReadOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",

...
/******************************************************************************/
void
sensorMonitor_adv_sensorB_readSensorValueFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            sensorMonitor_adv_sensorB_readSensorValueFunction_step((sensorMonitor_adv_sensorB_sensorBComponent_config_t* const) functionParameter);
            sensorMonitor_adv_sensorB_sensorBComponentWrapper_completeWriteOperations();
        }

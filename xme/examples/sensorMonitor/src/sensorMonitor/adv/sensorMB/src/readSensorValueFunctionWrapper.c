 ...
 *
 * $Id: readSensorValueFunctionWrapper.c 6326 2014-01-14 18:08:11Z gulati $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/readSensorValueFunctionWrapper.h"

#include "../include/sensorMBComponentWrapper.h"
#include "../include/readSensorValueFunction.h"
...
/******************************************************************************/
void
sensorMonitor_adv_sensorMB_readSensorValueFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            sensorMonitor_adv_sensorMB_readSensorValueFunction_step((sensorMonitor_adv_sensorMB_sensorMBComponent_config_t* const) functionParameter);
            sensorMonitor_adv_sensorMB_sensorMBComponentWrapper_completeWriteOperations();
        }

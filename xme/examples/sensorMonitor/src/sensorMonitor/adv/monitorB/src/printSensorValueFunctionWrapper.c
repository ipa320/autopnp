...
/******************************************************************************/
void
sensorMonitor_adv_monitorB_printSensorValueFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            sensorMonitor_adv_monitorB_printSensorValueFunction_step((sensorMonitor_adv_monitorB_monitorBComponent_config_t* const) functionParameter);
            sensorMonitor_adv_monitorB_monitorBComponentWrapper_completeReadOperations();
        }

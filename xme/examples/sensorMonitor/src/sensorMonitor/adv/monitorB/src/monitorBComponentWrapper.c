 ...
 *
 * $Id: monitorBComponentWrapper.c 7769 2014-03-11 15:27:13Z geisinger $
 */
...
static inputPort_t inputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } } // monitorB.sensorValueIn
};
...
sensorMonitor_adv_monitorB_monitorBComponentWrapper_completeReadOperations(void)
{
    ...
    for (inputPortIndex = 0U; inputPortIndex < inputPortCount; inputPortIndex++)
    {
        ...
        (void) sensorMonitor_adv_monitorB_monitorBComponentWrapper_readNextPacket(inputPortIndex);
    }
}

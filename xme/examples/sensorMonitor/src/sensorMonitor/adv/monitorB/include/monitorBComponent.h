 ...
 *
 * $Id: monitorBComponent.h 6380 2014-01-17 15:36:50Z wiesmueller $
 */

/**
 * \file
 *         Header file for monitorB component.
 *
 * \author
...
#ifndef SENSORMONITOR_ADV_MONITORB_MONITORBCOMPONENT_H
#define SENSORMONITOR_ADV_MONITORB_MONITORBCOMPONENT_H
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_MONITORB_MONITORBCOMPONENT_H_INCLUDES) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_MONITORB_MONITORBCOMPONENT_H_DEFINES) ENABLED START
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_MONITORB_MONITORBCOMPONENT_H_TYPE_DEFINITIONS) ENABLED START

// PROTECTED REGION END

/**
 * \typedef sensorMonitor_adv_monitorB_monitorBComponent_config_t
 *
...
typedef struct
{
    // PROTECTED REGION ID(SENSORMONITOR_ADV_MONITORB_MONITORBCOMPONENT_H_CONFIG) ENABLED START

    char dummy; ///< Dummy field, replace with actual component configuration.

// PROTECTED REGION END
} sensorMonitor_adv_monitorB_monitorBComponent_config_t;
...
// PROTECTED REGION ID(SENSORMONITOR_ADV_MONITORB_MONITORBCOMPONENT_H_PROTOTYPES) ENABLED START

// PROTECTED REGION END

XME_EXTERN_C_END

#endif // #ifndef SENSORMONITOR_ADV_MONITORB_MONITORBCOMPONENT_H

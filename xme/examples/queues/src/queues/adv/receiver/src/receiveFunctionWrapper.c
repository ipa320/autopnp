 ...
 *
 * $Id: receiveFunctionWrapper.c 6328 2014-01-14 18:22:57Z gulati $
 */
...
/******************************************************************************/
void
queues_adv_receiver_receiveFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            queues_adv_receiver_receiveFunction_step((queues_adv_receiver_receiverComponent_config_t* const) functionParameter);
            queues_adv_receiver_receiverComponentWrapper_completeReadOperations();
        }

 ...
 *
 * $Id: receiverComponentWrapper.c 7769 2014-03-11 15:27:13Z geisinger $
 */
...
static inputPort_t inputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } } // receiver.in
};
...
queues_adv_receiver_receiverComponentWrapper_completeReadOperations(void)
{
    ...
    for (inputPortIndex = 0U; inputPortIndex < inputPortCount; inputPortIndex++)
    {
        ...
        (void) queues_adv_receiver_receiverComponentWrapper_readNextPacket(inputPortIndex);
    }
}
...
)
{
    ...
    inputPortIndex = (uint8_t)QUEUES_ADV_RECEIVER_RECEIVERCOMPONENTWRAPPER_PORT_IN;
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_LOG_ERROR,
            "[receiverComponentWrapper] CompleteReadOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",

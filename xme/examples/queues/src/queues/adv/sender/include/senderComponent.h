 ...
 *
 * $Id: senderComponent.h 6328 2014-01-14 18:22:57Z gulati $
 */

/**
 * \file
 *         Header file for sender component.
 *
 * \author
...
#ifndef QUEUES_ADV_SENDER_SENDERCOMPONENT_H
#define QUEUES_ADV_SENDER_SENDERCOMPONENT_H
...
// PROTECTED REGION ID(QUEUES_ADV_SENDER_SENDERCOMPONENT_H_INCLUDES) ENABLED START
#include <stdint.h>
...
// PROTECTED REGION ID(QUEUES_ADV_SENDER_SENDERCOMPONENT_H_DEFINES) ENABLED START
...
// PROTECTED REGION ID(QUEUES_ADV_SENDER_SENDERCOMPONENT_H_TYPE_DEFINITIONS) ENABLED START

// PROTECTED REGION END

/**
 * \typedef queues_adv_sender_senderComponent_config_t
 *
...
typedef struct
{
    // PROTECTED REGION ID(QUEUES_ADV_SENDER_SENDERCOMPONENT_H_CONFIG) ENABLED START

    uint8_t instanceNumber; ///< Sender instance number.

// PROTECTED REGION END
} queues_adv_sender_senderComponent_config_t;
...
// PROTECTED REGION ID(QUEUES_ADV_SENDER_SENDERCOMPONENT_H_PROTOTYPES) ENABLED START

// PROTECTED REGION END

XME_EXTERN_C_END

#endif // #ifndef QUEUES_ADV_SENDER_SENDERCOMPONENT_H

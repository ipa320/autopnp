 ...
 *
 * $Id: master.cpp 7825 2014-03-14 08:29:35Z kainz $
 */
 ...
 *              5 | pnpClient.inLoginAcknowledgment
 *              6 | pnpClient.inGraph
 *              7 | pnpClient.outManifest
 *              8 | pnpClient.outLogoutAcknowledgment
 *              9 | pnpClient.outLogoutRequest
 *             10 | pnpClient.outRemoveComponentRequest
 *             11 | pnpManager.inComponentInstanceManifest
 *             12 | pnpManager.inPnPLoginRequest
 *             13 | pnpManager.inLogoutRequest
 *             14 | pnpManager.inLogoutAcknowledgment
 *             15 | pnpManager.inRemoveComponentRequest
 *             16 | pnpManager.outRuntimeGraph
 *             17 | pnpManager.outPnPLoginResponse
 *             18 | pnpManager.outLogoutNotification
 *             19 | proxy.message
 *             20 | proxy.receivedSum
 *             21 | proxy.getDifference
 *             22 | proxy.receivedMessage
 *             23 | proxy.getSum
 *             24 | proxy.sendDifference
 *             25 | system.messageStatus
 *             26 | system.getSum
 *             27 | system.receivedDifference
 *             28 | system.message
 *             29 | system.sendSum
 *             30 | system.getDifference
 *             31 | demarshaler.configuration[0].out (loginManager.inLoginRequest)
 *             32 | demarshaler.configuration[1].out (pnpClient.inGraph)
 *             33 | demarshaler.configuration[2].out (pnpManager.inLogoutRequest)
 *             34 | demarshaler.configuration[3].out (pnpManager.inLogoutAcknowledgment)
 *             35 | demarshaler.configuration[0].in (loginManager.inLoginRequest)
 *             36 | demarshaler.configuration[1].in (pnpClient.inGraph)
 *             37 | demarshaler.configuration[2].in (pnpManager.inLogoutRequest)
 *             38 | demarshaler.configuration[3].in (pnpManager.inLogoutAcknowledgment)
 *             39 | udpReceive.configuration[0].out (loginManager.inLoginRequest)
 *             40 | udpReceive.configuration[1].out (pnpClient.inGraph)
 *             41 | udpReceive.configuration[2].out (pnpManager.inLogoutRequest)
 *             42 | udpReceive.configuration[3].out (pnpManager.inLogoutAcknowledgment)
 *             43 | channelInjector.configuration[0].out (proxy.getSum)
 *             44 | channelInjector.configuration[1].out (system.getDifference)
 *             45 | channelInjector.configuration[0].in (proxy.getSum)
 *             46 | channelInjector.configuration[1].in (system.getDifference)
 *             47 | channelSelector.configuration[0].out (proxy.sendDifference)
 *             48 | channelSelector.configuration[1].out (system.sendSum)
 *             49 | channelSelector.configuration[0].in (proxy.sendDifference)
 *             50 | channelSelector.configuration[1].in (system.sendSum)
 */
static xme_core_dataManager_dataPacketId_t ports[51];
 ...
 */
static void* channelInjectorBuffers[2];
/**
 * \brief Buffers required by ChannelSelector.
 */
static void* channelSelectorBuffers[2];
static xme_core_exec_functionDescriptor_t* loginManagerFuncDescs[3] = {NULL, NULL, NULL};
static xme_core_exec_functionDescriptor_t* systemFuncDescs[5] = {NULL, NULL, NULL, NULL, NULL};
static xme_core_exec_functionDescriptor_t* rOSFuncDescs[1] = {NULL};
static xme_core_exec_functionDescriptor_t* proxyFuncDescs[4] = {NULL, NULL, NULL, NULL};
...
static xme_wp_waypoint_instanceId_t channelInjectorWaypointInstanceIds[2] = { XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID };
static xme_core_exec_functionDescriptor_t* channelSelectorWaypointDescriptor = NULL;
static xme_wp_waypoint_instanceId_t channelSelectorWaypointInstanceIds[2] = { XME_WP_WAYPOINT_INSTANCEID_INVALID, XME_WP_WAYPOINT_INSTANCEID_INVALID };
...
pnpInit(void)
{
    ...
    announceComponentPortsToPnpClient((xme_core_component_t)129); // Component 'system' of type 'system'
    announceComponentPortsToPnpClient((xme_core_component_t)130); // Component 'ROS' of type 'ROS'
    announceComponentPortsToPnpClient((xme_core_component_t)131); // Component 'proxy' of type 'proxy'
    ...
    (
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)129, // from node 'master' component 'system'
        3, // publication 'message'
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)131, // to node 'master' component 'proxy'
        0, // subscription 'message'
        (xme_core_channelId_t)10008
    );
    if (XME_STATUS_SUCCESS != status)
    {
        XME_LOG
        (
            XME_LOG_WARNING,
            "%s:%d A call to xme_core_pnp_pnpManager_announceChannelId() component failed with status %d.\n\
            This will cause improper removal of the affected components ('system' and 'proxy')\n",
            __FILE__,
            __LINE__,
            status
        );
    ...
    (
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)131, // from node 'master' component 'proxy'
        3, // publication 'receivedMessage'
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)129, // to node 'master' component 'system'
        0, // subscription 'messageStatus'
        (xme_core_channelId_t)10009
    );
    if (XME_STATUS_SUCCESS != status)
    {
        XME_LOG
        (
            XME_LOG_WARNING,
            "%s:%d A call to xme_core_pnp_pnpManager_announceChannelId() component failed with status %d.\n\
            This will cause improper removal of the affected components ('proxy' and 'system')\n",
            __FILE__,
            __LINE__,
            status
        );
    ...
    (
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)131, // from node 'master' component 'proxy'
        4, // publication 'getSum'
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)129, // to node 'master' component 'system'
        1, // subscription 'getSum'
        (xme_core_channelId_t)10010
    );
    if (XME_STATUS_SUCCESS != status)
    {
        XME_LOG
    ...
    (
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)129, // from node 'master' component 'system'
        4, // publication 'sendSum'
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)131, // to node 'master' component 'proxy'
        1, // subscription 'receivedSum'
        (xme_core_channelId_t)10011
    );
    if (XME_STATUS_SUCCESS != status)
    {
        XME_LOG
    ...
    (
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)129, // from node 'master' component 'system'
        5, // publication 'getDifference'
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)131, // to node 'master' component 'proxy'
        2, // subscription 'getDifference'
        (xme_core_channelId_t)10012
    );
    if (XME_STATUS_SUCCESS != status)
    {
        XME_LOG
    ...
    (
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)131, // from node 'master' component 'proxy'
        5, // publication 'sendDifference'
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)129, // to node 'master' component 'system'
        2, // subscription 'receivedDifference'
        (xme_core_channelId_t)10013
    );
    if (XME_STATUS_SUCCESS != status)
    {
        XME_LOG
    ...
    // Node 'master', component 'ROS' of type 'ROS'
    status = xme_core_pnp_pnpManager_announcePorts
    (
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)130,
        (xme_core_componentType_t)4099
    );
    ...
    // Node 'master', component 'proxy' of type 'proxy'
    status = xme_core_pnp_pnpManager_announcePorts
    (
        (xme_core_node_nodeId_t)1,
    ...
    // Node 'master', component 'system' of type 'system'
    status = xme_core_pnp_pnpManager_announcePorts
    (
        (xme_core_node_nodeId_t)1,
        (xme_core_component_t)129,
        (xme_core_componentType_t)4098
    );
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, status, XME_LOG_FATAL, ".\n");
...
configureSchedule(void)
{
    ...
    // Component 'system' function 'sendMessage'
    if (NULL != systemFuncDescs[0])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(systemFuncDescs[0], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    // Component 'system' function 'receiveMessageStatus'
    if (NULL != systemFuncDescs[1])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(systemFuncDescs[1], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    // Component 'system' function 'getSum'
    if (NULL != systemFuncDescs[2])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(systemFuncDescs[2], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    // Component 'system' function 'askDifference'
    if (NULL != systemFuncDescs[3])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(systemFuncDescs[3], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    // Component 'system' function 'receiveDifference'
    if (NULL != systemFuncDescs[4])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(systemFuncDescs[4], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    // Component 'ROS' function 'executeROS'
    if (NULL != rOSFuncDescs[0])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(rOSFuncDescs[0], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    // Component 'proxy' function 'receiveMessage'
    if (NULL != proxyFuncDescs[0])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(proxyFuncDescs[0], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    // Component 'proxy' function 'askSum'
    if (NULL != proxyFuncDescs[1])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(proxyFuncDescs[1], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    // Component 'proxy' function 'receiveSum'
    if (NULL != proxyFuncDescs[2])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(proxyFuncDescs[2], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    // Component 'proxy' function 'getDifference'
    if (NULL != proxyFuncDescs[3])
    {
        status = xme_core_exec_dispatcher_createFunctionExecutionUnit(proxyFuncDescs[3], true);
        XME_ASSERT_NORVAL(XME_STATUS_SUCCESS == status);
    }
    ...
    (
        &(nodeSchedules[0]),
        xme_hal_time_timeIntervalFromMilliseconds(1555ull)
    );

    if (NULL != systemFuncDescs[0])
    {
        // Add function 'sendMessage' of component instance 'system' of type 'system' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            systemFuncDescs[0]->componentId,
            systemFuncDescs[0]->functionId,
            systemFuncDescs[0]->taskArgs,
            xme_hal_time_timeIntervalFromSeconds(0ull),
            xme_hal_time_timeIntervalFromMilliseconds(1ull),
            1,
            0,
            true
        );
    ...
    if (NULL != systemFuncDescs[3])
    {
        // Add function 'askDifference' of component instance 'system' of type 'system' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            systemFuncDescs[3]->componentId,
            systemFuncDescs[3]->functionId,
            systemFuncDescs[3]->taskArgs,
            xme_hal_time_timeIntervalFromMilliseconds(1ull),
            xme_hal_time_timeIntervalFromMilliseconds(1ull),
            1,
            0,
    ...
    {
        // Add channelinjector waypoint configuration for component port 'system.getDifference'to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            channelInjectorWaypointDescriptor->componentId,
            channelInjectorWaypointDescriptor->functionId,
            (void *)(uintptr_t)channelInjectorWaypointInstanceIds[1],
            xme_hal_time_timeIntervalFromMilliseconds(2ull),
    ...
    if (NULL != proxyFuncDescs[1])
    {
        // Add function 'askSum' of component instance 'proxy' of type 'proxy' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            proxyFuncDescs[1]->componentId,
            proxyFuncDescs[1]->functionId,
            proxyFuncDescs[1]->taskArgs,
            xme_hal_time_timeIntervalFromMilliseconds(7ull),
            xme_hal_time_timeIntervalFromMilliseconds(1ull),
            1,
            0,
            true
    ...
    if (NULL != channelInjectorWaypointDescriptor)
    {
        // Add channelinjector waypoint configuration for component port 'proxy.getSum'to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            channelInjectorWaypointDescriptor->componentId,
            ...
            xme_hal_time_timeIntervalFromMilliseconds(8ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != pnpClientFuncDescs[2])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(13ull),
    ...
    if (NULL != pnpClientFuncDescs[3])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(23ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != udpReceiveWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(28ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != demarshalerWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(33ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != loginManagerFuncDescs[0])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(38ull),
    ...
    if (NULL != loginManagerFuncDescs[1])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(138ull),
            xme_hal_time_timeIntervalFromMilliseconds(100ull),
            1,
            0,
            true
    ...
    if (NULL != channelInjectorWaypointDescriptor)
    {
        // Add channelinjector waypoint configuration for component port 'system.getSum'to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            channelInjectorWaypointDescriptor->componentId,
            channelInjectorWaypointDescriptor->functionId,
            (void *)(uintptr_t)channelInjectorWaypointInstanceIds[0],
            xme_hal_time_timeIntervalFromMilliseconds(238ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != systemFuncDescs[2])
    {
        // Add function 'getSum' of component instance 'system' of type 'system' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            systemFuncDescs[2]->componentId,
            systemFuncDescs[2]->functionId,
            systemFuncDescs[2]->taskArgs,
            xme_hal_time_timeIntervalFromMilliseconds(243ull),
            xme_hal_time_timeIntervalFromMilliseconds(1ull),
            1,
            0,
            true
    ...
    if (NULL != channelSelectorWaypointDescriptor)
    {
        // Add channelselector waypoint configuration for component port 'system.sendSum'to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            channelSelectorWaypointDescriptor->componentId,
            channelSelectorWaypointDescriptor->functionId,
            (void *)(uintptr_t)channelSelectorWaypointInstanceIds[1],
            xme_hal_time_timeIntervalFromMilliseconds(244ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != pnpClientFuncDescs[0])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(249ull),
            xme_hal_time_timeIntervalFromMilliseconds(10ull),
            1,
            0,
            true
    ...
    if (NULL != udpReceiveWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(259ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != demarshalerWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(264ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != pnpClientFuncDescs[1])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(269ull),
            xme_hal_time_timeIntervalFromMilliseconds(10ull),
            1,
            0,
            true
    ...
    if (NULL != pnpManagerFuncDescs[0])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(279ull),
            xme_hal_time_timeIntervalFromMilliseconds(100ull),
            1,
            0,
            true
    ...
    if (NULL != pnpManagerFuncDescs[1])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(379ull),
            xme_hal_time_timeIntervalFromMilliseconds(100ull),
            1,
            0,
            true
    ...
    if (NULL != udpReceiveWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(479ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != demarshalerWaypointDescriptor)
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(484ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != pnpManagerFuncDescs[3])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(489ull),
            xme_hal_time_timeIntervalFromMilliseconds(10ull),
            1,
            0,
            true
    ...
    if (NULL != loginManagerFuncDescs[2])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(499ull),
            xme_hal_time_timeIntervalFromMilliseconds(10ull),
            1,
            0,
            true
    ...
    if (NULL != systemFuncDescs[1])
    {
        // Add function 'receiveMessageStatus' of component instance 'system' of type 'system' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            systemFuncDescs[1]->componentId,
            systemFuncDescs[1]->functionId,
            systemFuncDescs[1]->taskArgs,
            xme_hal_time_timeIntervalFromMilliseconds(509ull),
            xme_hal_time_timeIntervalFromMilliseconds(1ull),
            1,
            0,
            true
    ...
    if (NULL != channelSelectorWaypointDescriptor)
    {
        // Add channelselector waypoint configuration for component port 'system.receivedDifference'to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            channelSelectorWaypointDescriptor->componentId,
            channelSelectorWaypointDescriptor->functionId,
            (void *)(uintptr_t)channelSelectorWaypointInstanceIds[0],
    ...
    if (NULL != systemFuncDescs[4])
    {
        // Add function 'receiveDifference' of component instance 'system' of type 'system' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            systemFuncDescs[4]->componentId,
            systemFuncDescs[4]->functionId,
            systemFuncDescs[4]->taskArgs,
            xme_hal_time_timeIntervalFromMilliseconds(515ull),
            xme_hal_time_timeIntervalFromMilliseconds(1ull),
            1,
            0,
            true
    ...
    if (NULL != rOSFuncDescs[0])
    {
        // Add function 'executeROS' of component instance 'ROS' of type 'ROS' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            rOSFuncDescs[0]->componentId,
            rOSFuncDescs[0]->functionId,
            rOSFuncDescs[0]->taskArgs,
            xme_hal_time_timeIntervalFromMilliseconds(516ull),
            xme_hal_time_timeIntervalFromMilliseconds(1ull),
            1,
            0,
            true
    ...
    if (NULL != proxyFuncDescs[0])
    {
        // Add function 'receiveMessage' of component instance 'proxy' of type 'proxy' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            proxyFuncDescs[0]->componentId,
            proxyFuncDescs[0]->functionId,
            proxyFuncDescs[0]->taskArgs,
            xme_hal_time_timeIntervalFromMilliseconds(517ull),
            xme_hal_time_timeIntervalFromMilliseconds(1ull),
            1,
            0,
            true
    ...
    if (NULL != channelSelectorWaypointDescriptor)
    {
        // Add channelselector waypoint configuration for component port 'proxy.receivedSum'to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            channelSelectorWaypointDescriptor->componentId,
            channelSelectorWaypointDescriptor->functionId,
            (void *)(uintptr_t)channelSelectorWaypointInstanceIds[1],
            xme_hal_time_timeIntervalFromMilliseconds(518ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != proxyFuncDescs[2])
    {
        // Add function 'receiveSum' of component instance 'proxy' of type 'proxy' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            proxyFuncDescs[2]->componentId,
            proxyFuncDescs[2]->functionId,
            proxyFuncDescs[2]->taskArgs,
            xme_hal_time_timeIntervalFromMilliseconds(523ull),
            xme_hal_time_timeIntervalFromMilliseconds(1ull),
            1,
            0,
            true
    ...
    if (NULL != channelInjectorWaypointDescriptor)
    {
        // Add channelinjector waypoint configuration for component port 'proxy.getDifference'to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            channelInjectorWaypointDescriptor->componentId,
            channelInjectorWaypointDescriptor->functionId,
            (void *)(uintptr_t)channelInjectorWaypointInstanceIds[1],
            xme_hal_time_timeIntervalFromMilliseconds(524ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
    ...
    if (NULL != proxyFuncDescs[3])
    {
        // Add function 'getDifference' of component instance 'proxy' of type 'proxy' to schedule
        status = xme_core_exec_scheduler_addElementToScheduleTable
        (
            nodeSchedules[0],
            proxyFuncDescs[3]->componentId,
            proxyFuncDescs[3]->functionId,
            proxyFuncDescs[3]->taskArgs,
            xme_hal_time_timeIntervalFromMilliseconds(529ull),
            xme_hal_time_timeIntervalFromMilliseconds(1ull),
            1,
            0,
            true
    ...
    if (NULL != pnpManagerFuncDescs[4])
    {
        ...
        (
            ...
            xme_hal_time_timeIntervalFromMilliseconds(550ull),
            xme_hal_time_timeIntervalFromMilliseconds(5ull),
            1,
            0,
            true
...
createComponentInstances(void)
{
    ...
    // Create statically configured component instance 'system' of type 'system'
    {
        xme_core_nodeMgr_compRep_componentBuilder_t* builder = NULL;
        xme_core_nodeMgr_compRep_componentHandle_t componentHandle;

        builder = xme_core_nodeMgr_compRep_createBuilder(XME_CORE_NODE_LOCAL_NODE_ID, (xme_core_componentType_t)4098);
        XME_CHECK_MSG(NULL != builder, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'system' of type 'system' failed. Builder could not be created.\n", __FILE__, __LINE__);
        xme_core_nodeMgr_compRep_builderSetComponentID(builder, (xme_core_component_t)129);
        status = xme_core_nodeMgr_compRep_build(builder, &componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'system' of type 'system' failed. Building of component failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_setStateToAnnounced(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'system' of type 'system' failed. Setting state to ANNOUNCED failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_createAndRegisterComponent(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'system' of type 'system' failed. Registration and port allocation failed.\n", __FILE__, __LINE__);

        ports[25] = getDataPacketID((xme_core_component_t)129, 0);
        ports[26] = getDataPacketID((xme_core_component_t)129, 1);
        ports[27] = getDataPacketID((xme_core_component_t)129, 2);
        ports[28] = getDataPacketID((xme_core_component_t)129, 3);
        ports[29] = getDataPacketID((xme_core_component_t)129, 4);
        ports[30] = getDataPacketID((xme_core_component_t)129, 5);
        
        systemFuncDescs[0] = getFunctionDescriptor((xme_core_component_t)129, 0);
        systemFuncDescs[1] = getFunctionDescriptor((xme_core_component_t)129, 1);
        systemFuncDescs[2] = getFunctionDescriptor((xme_core_component_t)129, 2);
        systemFuncDescs[3] = getFunctionDescriptor((xme_core_component_t)129, 3);
        systemFuncDescs[4] = getFunctionDescriptor((xme_core_component_t)129, 4);
    }
    
    // Create statically configured component instance 'ROS' of type 'ROS'
    {
        xme_core_nodeMgr_compRep_componentBuilder_t* builder = NULL;
        xme_core_nodeMgr_compRep_componentHandle_t componentHandle;

        builder = xme_core_nodeMgr_compRep_createBuilder(XME_CORE_NODE_LOCAL_NODE_ID, (xme_core_componentType_t)4099);
        XME_CHECK_MSG(NULL != builder, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'ROS' of type 'ROS' failed. Builder could not be created.\n", __FILE__, __LINE__);
        xme_core_nodeMgr_compRep_builderSetComponentID(builder, (xme_core_component_t)130);
        status = xme_core_nodeMgr_compRep_build(builder, &componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'ROS' of type 'ROS' failed. Building of component failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_setStateToAnnounced(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'ROS' of type 'ROS' failed. Setting state to ANNOUNCED failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_createAndRegisterComponent(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'ROS' of type 'ROS' failed. Registration and port allocation failed.\n", __FILE__, __LINE__);

        
        rOSFuncDescs[0] = getFunctionDescriptor((xme_core_component_t)130, 0);
    }
    
    // Create statically configured component instance 'proxy' of type 'proxy'
    {
        xme_core_nodeMgr_compRep_componentBuilder_t* builder = NULL;
        xme_core_nodeMgr_compRep_componentHandle_t componentHandle;

        builder = xme_core_nodeMgr_compRep_createBuilder(XME_CORE_NODE_LOCAL_NODE_ID, (xme_core_componentType_t)4097);
        XME_CHECK_MSG(NULL != builder, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'proxy' of type 'proxy' failed. Builder could not be created.\n", __FILE__, __LINE__);
        xme_core_nodeMgr_compRep_builderSetComponentID(builder, (xme_core_component_t)131);
        status = xme_core_nodeMgr_compRep_build(builder, &componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'proxy' of type 'proxy' failed. Building of component failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_setStateToAnnounced(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'proxy' of type 'proxy' failed. Setting state to ANNOUNCED failed.\n", __FILE__, __LINE__);

        status = xme_core_nodeMgr_compRep_createAndRegisterComponent(componentHandle);
        XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Creation of component instance 'proxy' of type 'proxy' failed. Registration and port allocation failed.\n", __FILE__, __LINE__);

        ports[19] = getDataPacketID((xme_core_component_t)131, 0);
        ports[20] = getDataPacketID((xme_core_component_t)131, 1);
        ports[21] = getDataPacketID((xme_core_component_t)131, 2);
        ports[22] = getDataPacketID((xme_core_component_t)131, 3);
        ports[23] = getDataPacketID((xme_core_component_t)131, 4);
        ports[24] = getDataPacketID((xme_core_component_t)131, 5);
        
        proxyFuncDescs[0] = getFunctionDescriptor((xme_core_component_t)131, 0);
        proxyFuncDescs[1] = getFunctionDescriptor((xme_core_component_t)131, 1);
        proxyFuncDescs[2] = getFunctionDescriptor((xme_core_component_t)131, 2);
        proxyFuncDescs[3] = getFunctionDescriptor((xme_core_component_t)131, 3);
    }
    ...
    // Create statically configured component instance 'pnpClient' of type 'pnpClient'
    {
        ...
        ports[5] = getDataPacketID((xme_core_component_t)4, 0);
        ports[6] = getDataPacketID((xme_core_component_t)4, 1);
        ports[7] = getDataPacketID((xme_core_component_t)4, 2);
        ports[8] = getDataPacketID((xme_core_component_t)4, 3);
        ports[9] = getDataPacketID((xme_core_component_t)4, 4);
        ports[10] = getDataPacketID((xme_core_component_t)4, 5);
    ...
    // Create statically configured component instance 'pnpManager' of type 'pnpManager'
    {
        ...
        ports[11] = getDataPacketID((xme_core_component_t)3, 0);
        ports[12] = getDataPacketID((xme_core_component_t)3, 1);
        ports[13] = getDataPacketID((xme_core_component_t)3, 2);
        ports[14] = getDataPacketID((xme_core_component_t)3, 3);
        ports[15] = getDataPacketID((xme_core_component_t)3, 4);
        ports[16] = getDataPacketID((xme_core_component_t)3, 5);
        ports[17] = getDataPacketID((xme_core_component_t)3, 6);
        ports[18] = getDataPacketID((xme_core_component_t)3, 7);
...
createWaypoints(void)
{
...

    {
        ...
        if (NULL != demarshalerWaypointDescriptor)
        {
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[35], // demarshaler.configuration[0].in (loginManager.inLoginRequest)
                1,
                &ports[31], // demarshaler.configuration[0].out (loginManager.inLoginRequest)
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[36], // demarshaler.configuration[1].in (pnpClient.inGraph)
                1,
                &ports[32], // demarshaler.configuration[1].out (pnpClient.inGraph)
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[37], // demarshaler.configuration[2].in (pnpManager.inLogoutRequest)
                1,
                &ports[33], // demarshaler.configuration[2].out (pnpManager.inLogoutRequest)
            ...
            (
                demarshalerWaypointDescriptor,
                &ports[38], // demarshaler.configuration[3].in (pnpManager.inLogoutAcknowledgment)
                1,
                &ports[34], // demarshaler.configuration[3].out (pnpManager.inLogoutAcknowledgment)
        ...
        {
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[39], // udpReceive.configuration[0].out (loginManager.inLoginRequest)
                    key,
                    33200,
                    XME_CORE_TOPIC_LOGIN_LOGINREQUEST,
                    sizeof(xme_core_topic_login_loginRequest_t),
            ...
            }
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[40], // udpReceive.configuration[1].out (pnpClient.inGraph)
                    key,
                    65000,
                    XME_CORE_TOPIC_PNPMANAGER_RUNTIME_GRAPH_MODEL,
                    sizeof(xme_core_topic_pnpManager_runtime_graph_model_t),
            ...
            }
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[41], // udpReceive.configuration[2].out (pnpManager.inLogoutRequest)
                    key,
                    65000,
                    XME_CORE_TOPIC_PNP_LOGOUTREQUEST,
                    sizeof(xme_core_topic_pnp_logoutRequest_t),
            ...
            }
            {
                ...
                (
                    udpReceiveWaypointDescriptor,
                    &ports[42], // udpReceive.configuration[3].out (pnpManager.inLogoutAcknowledgment)
                    key,
                    65000,
                    XME_CORE_TOPIC_PNP_LOGOUTACKNOWLEDGMENT,
                    sizeof(xme_core_topic_pnp_logoutAcknowledgment_t),
...

    {
        ...
        if (NULL != channelInjectorWaypointDescriptor)
        {
            ...
            (
                channelInjectorWaypointDescriptor,
                &ports[45], // channelInjector.configuration[0].in (proxy.getSum)
                1,
                &ports[43], // channelInjector.configuration[0].out (proxy.getSum)
                (xme_core_channelId_t) 10010,
                ROSGATEWAY_TOPIC_SUMREQUEST,
                sizeof(ROSGateway_topic_sumRequest_t),
            ...
            (
                channelInjectorWaypointDescriptor,
                &ports[46], // channelInjector.configuration[1].in (system.getDifference)
                1,
                &ports[44], // channelInjector.configuration[1].out (system.getDifference)
                (xme_core_channelId_t) 10012,
                ROSGATEWAY_TOPIC_DIFFERENCEREQUEST,
                sizeof(ROSGateway_topic_differenceRequest_t),
                &channelInjectorWaypointInstanceIds[1],
                &channelInjectorBuffers[1]
            );
        }
    }
    ...
    createChannelSelectorWaypointInstance
    (
        &channelSelectorWaypointDescriptor,
        (xme_core_component_t)10
    );

    {
        // Add channel selector configurations
        if (NULL != channelSelectorWaypointDescriptor)
        {
            channelSelectorWaypointAddConfig
            (
                channelSelectorWaypointDescriptor,
                &channelSelectorWaypointInstanceIds[0],
                &ports[49], // channelSelector.configuration[0].in (proxy.sendDifference)
                1,
                &ports[47], // channelSelector.configuration[0].out (proxy.sendDifference)
                ROSGATEWAY_TOPIC_DIFFERENCERESPONSE,
                sizeof(ROSGateway_topic_differenceResponse_t),
                (xme_core_channelId_t) 10012,
                (xme_core_channelId_t) 10013,
                &channelSelectorBuffers[0]
            );
            channelSelectorWaypointAddConfig
            (
                channelSelectorWaypointDescriptor,
                &channelSelectorWaypointInstanceIds[1],
                &ports[50], // channelSelector.configuration[1].in (system.sendSum)
                1,
                &ports[48], // channelSelector.configuration[1].out (system.sendSum)
                ROSGATEWAY_TOPIC_SUMRESPONSE,
                sizeof(ROSGateway_topic_sumResponse_t),
                (xme_core_channelId_t) 10010,
                (xme_core_channelId_t) 10011,
                &channelSelectorBuffers[1]
            );
        }
    }
}
...
registerTopicsAndAttributes(void)
{
    ...
    // Register topic data size for topic 'message'
    {
        xme_status_t status;
        ...
        (
            ...
            sizeof(ROSGateway_topic_message_t),
            false
        );
    ...
    // Register attribute descriptor list for topic 'message'
    {
        xme_status_t status;
        xme_core_attribute_descriptor_list_t attributeDescriptorList;
        xme_core_attribute_descriptor_t attributeDescriptors[1];
        ...
        if (status != XME_STATUS_SUCCESS)
        {
            XME_LOG(XME_LOG_WARNING, "Registration of attribute descriptor list for topic 'message' failed.\n");
        }
    }
    
    // Register topic data size for topic 'status'
    {
        xme_status_t status;
        ...
        (
            ...
            sizeof(ROSGateway_topic_status_t),
            false
        );
    ...
    // Register attribute descriptor list for topic 'status'
    {
        xme_status_t status;
        xme_core_attribute_descriptor_list_t attributeDescriptorList;
        xme_core_attribute_descriptor_t attributeDescriptors[1];
        ...
        if (status != XME_STATUS_SUCCESS)
        {
            XME_LOG(XME_LOG_WARNING, "Registration of attribute descriptor list for topic 'status' failed.\n");
        }
    }
    
    // Register topic data size for topic 'sumRequest'
    {
        xme_status_t status;
    ...
    // Register attribute descriptor list for topic 'sumRequest'
    {
        xme_status_t status;
        xme_core_attribute_descriptor_list_t attributeDescriptorList;
        xme_core_attribute_descriptor_t attributeDescriptors[1];
        ...
        if (status != XME_STATUS_SUCCESS)
        {
            XME_LOG(XME_LOG_WARNING, "Registration of attribute descriptor list for topic 'sumRequest' failed.\n");
        }
    }
    
    // Register topic data size for topic 'sumResponse'
    {
        xme_status_t status;
    ...
    // Register attribute descriptor list for topic 'sumResponse'
    {
        xme_status_t status;
        xme_core_attribute_descriptor_list_t attributeDescriptorList;
        xme_core_attribute_descriptor_t attributeDescriptors[1];
        ...
        if (status != XME_STATUS_SUCCESS)
        {
            XME_LOG(XME_LOG_WARNING, "Registration of attribute descriptor list for topic 'sumResponse' failed.\n");
        }
    }
    
    // Register topic data size for topic 'differenceRequest'
    {
        xme_status_t status;
    ...
    // Register attribute descriptor list for topic 'differenceRequest'
    {
        xme_status_t status;
        xme_core_attribute_descriptor_list_t attributeDescriptorList;
        xme_core_attribute_descriptor_t attributeDescriptors[1];
        ...
        if (status != XME_STATUS_SUCCESS)
        {
            XME_LOG(XME_LOG_WARNING, "Registration of attribute descriptor list for topic 'differenceRequest' failed.\n");
        }
    }
    
    // Register topic data size for topic 'differenceResponse'
    {
        xme_status_t status;
    ...
    // Register attribute descriptor list for topic 'differenceResponse'
    {
        xme_status_t status;
        xme_core_attribute_descriptor_list_t attributeDescriptorList;
        xme_core_attribute_descriptor_t attributeDescriptors[1];
        ...
        if (status != XME_STATUS_SUCCESS)
        {
            XME_LOG(XME_LOG_WARNING, "Registration of attribute descriptor list for topic 'differenceResponse' failed.\n");
        }
    }
...
createComponentTypeManifests(void)
{
    ...
    // Create and add manifest for component type 'ROS' to manifest repository
    {
        xme_core_componentManifest_t componentManifest;

        status = rOSGateway_adv_rOS_manifest_createComponentTypeManifest(&componentManifest);

        if (XME_STATUS_SUCCESS != status)
        {
            XME_LOG(XME_LOG_WARNING, "Creation of component type manifest for 'ROS' failed.\n");
        }
        else
        {
            ...
            if (XME_STATUS_SUCCESS != status)
            {
                XME_LOG(XME_LOG_WARNING, "Addtion of component type manifest to manifest repository failed for 'ROS'.\n");
            }
        }
    }
    ...
    // Create and add manifest for component type 'proxy' to manifest repository
    {
        xme_core_componentManifest_t componentManifest;

        status = rOSGateway_adv_proxy_manifest_createComponentTypeManifest(&componentManifest);

        if (XME_STATUS_SUCCESS != status)
        {
            XME_LOG(XME_LOG_WARNING, "Creation of component type manifest for 'proxy' failed.\n");
        }
        else
        {
            status = xme_core_manifestRepository_addComponentManifest(&componentManifest, false);
            ...
            if (XME_STATUS_SUCCESS != status)
            {
                XME_LOG(XME_LOG_WARNING, "Addtion of component type manifest to manifest repository failed for 'proxy'.\n");
            }
        }
    }
    
    // Create and add manifest for component type 'system' to manifest repository
    {
        xme_core_componentManifest_t componentManifest;

        status = rOSGateway_adv_system_manifest_createComponentTypeManifest(&componentManifest);

        if (XME_STATUS_SUCCESS != status)
        {
            XME_LOG(XME_LOG_WARNING, "Creation of component type manifest for 'system' failed.\n");
        }
        else
        {
            status = xme_core_manifestRepository_addComponentManifest(&componentManifest, false);
            ...
            if (XME_STATUS_SUCCESS != status)
            {
                XME_LOG(XME_LOG_WARNING, "Addtion of component type manifest to manifest repository failed for 'system'.\n");
            }
        }
    }
}
...
registerComponentTypesInLoggingEngine(void)
{
    ...
    {
        // Register component type 'ROS' in logging engine
        status = xme_core_log_registerComponent((xme_core_log_componentID_t) 4099, "ROS", xme_core_log_getMinimumLogSeverityLevel());
        XME_LOG_IF
        (
            XME_STATUS_SUCCESS != status,
            XME_LOG_WARNING,
    ...
    {
        // Register component type 'proxy' in logging engine
        status = xme_core_log_registerComponent((xme_core_log_componentID_t) 4097, "proxy", xme_core_log_getMinimumLogSeverityLevel());
        XME_LOG_IF
        (
            XME_STATUS_SUCCESS != status,
            XME_LOG_WARNING,
    ...
    {
        // Register component type 'system' in logging engine
        status = xme_core_log_registerComponent((xme_core_log_componentID_t) 4098, "system", xme_core_log_getMinimumLogSeverityLevel());
        XME_LOG_IF
        (
            XME_STATUS_SUCCESS != status,
            XME_LOG_WARNING,
...
)
{
    ...
    // Free allocated buffers
    for (i = 0; i < sizeof(channelSelectorBuffers) / sizeof(channelSelectorBuffers[0]); i++)
    {
        xme_hal_mem_free(channelSelectorBuffers[i]);
    }
...
addDataPacketTransferEntries(void)
{
    ...
    status = xme_core_broker_addDataPacketTransferEntry(ports[3], ports[12]); // loginManager.outPnPLoginRequest -> pnpManager.inPnPLoginRequest
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[3], ports[12], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[7], ports[11]); // pnpClient.outManifest -> pnpManager.inComponentInstanceManifest
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[7], ports[11], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[8], ports[14]); // pnpClient.outLogoutAcknowledgment -> pnpManager.inLogoutAcknowledgment
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[8], ports[14], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[9], ports[13]); // pnpClient.outLogoutRequest -> pnpManager.inLogoutRequest
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[9], ports[13], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[10], ports[15]); // pnpClient.outRemoveComponentRequest -> pnpManager.inRemoveComponentRequest
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[10], ports[15], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[16], ports[6]); // pnpManager.outRuntimeGraph -> pnpClient.inGraph
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[16], ports[6], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[17], ports[1]); // pnpManager.outPnPLoginResponse -> loginManager.inPnPLoginResponse
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[17], ports[1], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[18], ports[2]); // pnpManager.outLogoutNotification -> loginManager.inLogoutNotification
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[18], ports[2], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[22], ports[25]); // proxy.receivedMessage -> system.messageStatus
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[22], ports[25], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[23], ports[45]); // proxy.getSum -> channelInjector.configuration[0].in (proxy.getSum)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[23], ports[45], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[24], ports[49]); // proxy.sendDifference -> channelSelector.configuration[0].in (proxy.sendDifference)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[24], ports[49], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[28], ports[19]); // system.message -> proxy.message
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[28], ports[19], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[29], ports[50]); // system.sendSum -> channelSelector.configuration[1].in (system.sendSum)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[29], ports[50], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[30], ports[46]); // system.getDifference -> channelInjector.configuration[1].in (system.getDifference)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[30], ports[46], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[31], ports[0]); // demarshaler.configuration[0].out (loginManager.inLoginRequest) -> loginManager.inLoginRequest
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[31], ports[0], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[32], ports[6]); // demarshaler.configuration[1].out (pnpClient.inGraph) -> pnpClient.inGraph
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[32], ports[6], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[33], ports[13]); // demarshaler.configuration[2].out (pnpManager.inLogoutRequest) -> pnpManager.inLogoutRequest
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[33], ports[13], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[34], ports[14]); // demarshaler.configuration[3].out (pnpManager.inLogoutAcknowledgment) -> pnpManager.inLogoutAcknowledgment
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[34], ports[14], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[39], ports[35]); // udpReceive.configuration[0].out (loginManager.inLoginRequest) -> demarshaler.configuration[0].in (loginManager.inLoginRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[39], ports[35], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[40], ports[36]); // udpReceive.configuration[1].out (pnpClient.inGraph) -> demarshaler.configuration[1].in (pnpClient.inGraph)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[40], ports[36], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[41], ports[37]); // udpReceive.configuration[2].out (pnpManager.inLogoutRequest) -> demarshaler.configuration[2].in (pnpManager.inLogoutRequest)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[41], ports[37], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[42], ports[38]); // udpReceive.configuration[3].out (pnpManager.inLogoutAcknowledgment) -> demarshaler.configuration[3].in (pnpManager.inLogoutAcknowledgment)
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[42], ports[38], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[43], ports[26]); // channelInjector.configuration[0].out (proxy.getSum) -> system.getSum
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[43], ports[26], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[44], ports[21]); // channelInjector.configuration[1].out (system.getDifference) -> proxy.getDifference
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[44], ports[21], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[47], ports[27]); // channelSelector.configuration[0].out (proxy.sendDifference) -> system.receivedDifference
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[47], ports[27], status);
    status = xme_core_broker_addDataPacketTransferEntry(ports[48], ports[20]); // channelSelector.configuration[1].out (system.sendSum) -> proxy.receivedSum
    XME_CHECK_MSG(XME_STATUS_SUCCESS == status, XME_STATUS_INTERNAL_ERROR, XME_LOG_FATAL, "%s:%d Call to xme_core_broker_addDataPacketTransferEntry() failed for source data packet ID %d and destination data packet ID %d with status %d.\n", __FILE__, __LINE__, ports[48], ports[20], status);
...
main(int argc, char* argv[])
{
    ...
    xme_hal_ros_setCommandLineParameters(argc, argv);
    // PROTECTED REGION END
    ...
    if (NULL != channelSelectorWaypointDescriptor)
    {
        destroyChannelSelectorWaypointInstance(channelSelectorWaypointDescriptor);
    }

 ...
 *
 * $Id: marshaler.c 7637 2014-03-03 09:38:45Z kainz $
 */
...
/**
 * \brief  Performs marshaling for topic 'message'.
 *
...
/**
 * \brief  Performs marshaling for topic 'status'.
 *
 * \param  inputPort Input port where data is stored that will be marshaled.
 * \param  buffer Buffer where marshaled data will be written to.
 *
...
/**
 * \brief  Performs marshaling for topic 'sumRequest'.
 *
 * \param  inputPort Input port where data is stored that will be marshaled.
 * \param  buffer Buffer where marshaled data will be written to.
 *
...
/**
 * \brief  Performs marshaling for topic 'sumResponse'.
 *
 * \param  inputPort Input port where data is stored that will be marshaled.
 * \param  buffer Buffer where marshaled data will be written to.
 *
...
/**
 * \brief  Performs marshaling for topic 'differenceRequest'.
 *
 * \param  inputPort Input port where data is stored that will be marshaled.
 * \param  buffer Buffer where marshaled data will be written to.
 *
 ...
 */
xme_status_t
doMarshalingForDifferenceRequest
(
    xme_core_dataManager_dataPacketId_t inputPort,
    xme_core_dataManager_dataPacketId_t outputPort,
    void* buffer
...
/**
 * \brief  Performs marshaling for topic 'differenceResponse'.
 *
 * \param  inputPort Input port where data is stored that will be marshaled.
 * \param  buffer Buffer where marshaled data will be written to.
 *
 ...
 */
xme_status_t
doMarshalingForDifferenceResponse
(
    xme_core_dataManager_dataPacketId_t inputPort,
    xme_core_dataManager_dataPacketId_t outputPort,
    void* buffer
...
)
{
    ...
    else if (ROSGATEWAY_TOPIC_SUMREQUEST == topic)
    {
        ...
        status = doMarshalingForSumRequest
        (
            inputPort,
            outputPort,
            (void*)marshaledData
    ...
    else if (ROSGATEWAY_TOPIC_SUMRESPONSE == topic)
    {
        ...
        status = doMarshalingForSumResponse
        (
            inputPort,
            outputPort,
            (void*)marshaledData
    ...
    else if (ROSGATEWAY_TOPIC_DIFFERENCEREQUEST == topic)
    {
        ...
        status = doMarshalingForDifferenceRequest
        (
            inputPort,
            outputPort,
            (void*)marshaledData
    ...
    else if (ROSGATEWAY_TOPIC_DIFFERENCERESPONSE == topic)
    {
        ...
        status = doMarshalingForDifferenceResponse
        (
            inputPort,
            outputPort,
            (void*)marshaledData
...
)
{
    ...
    topicDataSize = sizeof(ROSGateway_topic_message_t);
...
)
{
    ...
    topicDataSize = sizeof(ROSGateway_topic_status_t);
    ...
    // char topicData.value
    {
        ...
        netValue = (0x00 == topicData.value) ? 0x00 : 0x01;
...
)
{
    ...
    topicDataSize = sizeof(ROSGateway_topic_sumRequest_t);
    ...
    // int64_t topicData.a
    {
        ...
        netValue = xme_hal_net_htonll((uint64_t)topicData.a);
    ...
    // int64_t topicData.b
    {
        ...
        netValue = xme_hal_net_htonll((uint64_t)topicData.b);
        xme_hal_mem_copy(bufferPtr, &netValue, sizeof(uint64_t));
        bufferPtr += sizeof(uint64_t);
    }
...
)
{
    ...
    topicDataSize = sizeof(ROSGateway_topic_sumResponse_t);
    ...
    // int64_t topicData.sum
    {
        ...
        netValue = xme_hal_net_htonll((uint64_t)topicData.sum);
        xme_hal_mem_copy(bufferPtr, &netValue, sizeof(uint64_t));
        bufferPtr += sizeof(uint64_t);
    }
...
)
{
    ...
    topicDataSize = sizeof(ROSGateway_topic_differenceRequest_t);
...
)
{
    ...
    topicDataSize = sizeof(ROSGateway_topic_differenceResponse_t);
    ...
    // int64_t topicData.difference
    {
        ...
        netValue = xme_hal_net_htonll((uint64_t)topicData.difference);
        xme_hal_mem_copy(bufferPtr, &netValue, sizeof(uint64_t));
        bufferPtr += sizeof(uint64_t);
    }

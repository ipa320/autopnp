 ...
 *
 * $Id: executeROSFunctionWrapper.cpp 6340 2014-01-15 13:52:06Z kainz $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/executeROSFunctionWrapper.h"

#include "../include/rOSComponentWrapper.h"
#include "../include/executeROSFunction.h"
...
/******************************************************************************/
void
rOSGateway_adv_rOS_executeROSFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            rOSGateway_adv_rOS_executeROSFunction_step((rOSGateway_adv_rOS_rOSComponent_config_t* const) functionParameter);
        }

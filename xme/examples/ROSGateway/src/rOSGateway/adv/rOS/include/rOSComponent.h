 ...
 *
 * $Id: rOSComponent.h 6356 2014-01-15 16:33:22Z kainz $
 */

/**
 * \file
 *         Header file for ROS component.
 *
 * \author
...
#ifndef ROSGATEWAY_ADV_ROS_ROSCOMPONENT_H
#define ROSGATEWAY_ADV_ROS_ROSCOMPONENT_H
...
// PROTECTED REGION ID(ROSGATEWAY_ADV_ROS_ROSCOMPONENT_H_INCLUDES) ENABLED START
...
// PROTECTED REGION ID(ROSGATEWAY_ADV_ROS_ROSCOMPONENT_H_DEFINES) ENABLED START
// PROTECTED REGION END
...
// PROTECTED REGION ID(ROSGATEWAY_ADV_ROS_ROSCOMPONENT_H_TYPE_DEFINITIONS) ENABLED START
// PROTECTED REGION END

/**
 * \typedef rOSGateway_adv_rOS_rOSComponent_config_t
 *
...
typedef struct
{
    // PROTECTED REGION ID(ROSGATEWAY_ADV_ROS_ROSCOMPONENT_H_CONFIG) ENABLED START
    char dummy; ///< Dummy field.
    // PROTECTED REGION END
} rOSGateway_adv_rOS_rOSComponent_config_t;
...
// PROTECTED REGION ID(ROSGATEWAY_ADV_ROS_ROSCOMPONENT_H_PROTOTYPES) ENABLED START
// PROTECTED REGION END

XME_EXTERN_C_END

#endif // #ifndef ROSGATEWAY_ADV_ROS_ROSCOMPONENT_H

 ...
 *
 * $Id: receiveDifferenceFunctionWrapper.c 7584 2014-02-25 14:32:15Z kainz $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/receiveDifferenceFunctionWrapper.h"

#include "../include/systemComponentWrapper.h"
#include "../include/receiveDifferenceFunction.h"
...
/******************************************************************************/
void
rOSGateway_adv_system_receiveDifferenceFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            rOSGateway_adv_system_receiveDifferenceFunction_step((rOSGateway_adv_system_systemComponent_config_t* const) functionParameter);
            rOSGateway_adv_system_systemComponentWrapper_completeReadOperations();
            rOSGateway_adv_system_systemComponentWrapper_completeWriteOperations();
        }

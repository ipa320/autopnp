 ...
 *
 * $Id: getSumFunctionWrapper.c 7584 2014-02-25 14:32:15Z kainz $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/getSumFunctionWrapper.h"

#include "../include/systemComponentWrapper.h"
#include "../include/getSumFunction.h"
...
/******************************************************************************/
void
rOSGateway_adv_system_getSumFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            rOSGateway_adv_system_getSumFunction_step((rOSGateway_adv_system_systemComponent_config_t* const) functionParameter);

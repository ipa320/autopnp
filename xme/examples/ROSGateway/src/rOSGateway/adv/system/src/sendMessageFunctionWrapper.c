 ...
 *
 * $Id: sendMessageFunctionWrapper.c 7584 2014-02-25 14:32:15Z kainz $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/sendMessageFunctionWrapper.h"

#include "../include/systemComponentWrapper.h"
#include "../include/sendMessageFunction.h"
...
/******************************************************************************/
void
rOSGateway_adv_system_sendMessageFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            rOSGateway_adv_system_sendMessageFunction_step((rOSGateway_adv_system_systemComponent_config_t* const) functionParameter);

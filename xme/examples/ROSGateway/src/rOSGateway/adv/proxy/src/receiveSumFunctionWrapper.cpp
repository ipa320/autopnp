 ...
 *
 * $Id: receiveSumFunctionWrapper.cpp 7584 2014-02-25 14:32:15Z kainz $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/receiveSumFunctionWrapper.h"

#include "../include/proxyComponentWrapper.h"
#include "../include/receiveSumFunction.h"
...
/******************************************************************************/
void
rOSGateway_adv_proxy_receiveSumFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            rOSGateway_adv_proxy_receiveSumFunction_step((rOSGateway_adv_proxy_proxyComponent_config_t* const) functionParameter);

 ...
 *
 * $Id: receiveMessageFunctionWrapper.cpp 7584 2014-02-25 14:32:15Z kainz $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/receiveMessageFunctionWrapper.h"

#include "../include/proxyComponentWrapper.h"
#include "../include/receiveMessageFunction.h"
...
/******************************************************************************/
void
rOSGateway_adv_proxy_receiveMessageFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            rOSGateway_adv_proxy_receiveMessageFunction_step((rOSGateway_adv_proxy_proxyComponent_config_t* const) functionParameter);
            rOSGateway_adv_proxy_proxyComponentWrapper_completeReadOperations();

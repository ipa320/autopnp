 ...
 *
 * $Id: proxyComponentWrapper.c 7774 2014-03-11 17:38:48Z geisinger $
 */
...
static inputPort_t inputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // proxy.message
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // proxy.receivedSum
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }  // proxy.getDifference
};
...
static outputPort_t outputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // proxy.receivedMessage
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // proxy.getSum
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }  // proxy.sendDifference
};
...
rOSGateway_adv_proxy_proxyComponentWrapper_completeReadOperations(void)
{
    ...
    for (inputPortIndex = 0U; inputPortIndex < inputPortCount; inputPortIndex++)
    {
        ...
        (void) rOSGateway_adv_proxy_proxyComponentWrapper_readNextPacket(inputPortIndex);
    }
}
...
rOSGateway_adv_proxy_proxyComponentWrapper_completeWriteOperations(void)
{
    ...
    for (outputPortIndex = inputPortCount; outputPortIndex < inputPortCount + outputPortCount; outputPortIndex++)
    {
        ...
        (void) rOSGateway_adv_proxy_proxyComponentWrapper_writeNextPacket(outputPortIndex);
    }
}
...
)
{
    ...
    inputPortIndex = (uint8_t)ROSGATEWAY_ADV_PROXY_PROXYCOMPONENTWRAPPER_PORT_MESSAGE;
...
)
{
    ...
    inputPortIndex = (uint8_t)ROSGATEWAY_ADV_PROXY_PROXYCOMPONENTWRAPPER_PORT_RECEIVEDSUM;
...
)
{
    ...
    inputPortIndex = (uint8_t)ROSGATEWAY_ADV_PROXY_PROXYCOMPONENTWRAPPER_PORT_GETDIFFERENCE;
    ...
    status = rOSGateway_adv_proxy_proxyComponentWrapper_readInputPortAttribute
    (
        (rOSGateway_adv_proxy_proxyComponentWrapper_internalPortId_t)ROSGATEWAY_ADV_PROXY_PROXYCOMPONENTWRAPPER_PORT_GETDIFFERENCE,
    ...
    (
        ...
        XME_LOG_ERROR,
        "%s:%d rOSGateway_adv_proxy_proxyComponentWrapper_readRequestHandlerPortGetDifference: Reading channel ID attribute from port failed. This is attribute is mandatory for request/response communication. Message cannot be delivered.\n",
        __FILE__,
        __LINE__
    );
...
)
{
    ...
    outputPortIndex = ((uint8_t)ROSGATEWAY_ADV_PROXY_PROXYCOMPONENTWRAPPER_PORT_RECEIVEDMESSAGE) - inputPortCount;
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[proxyComponentWrapper] writePortReceivedMessage(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    outputPortIndex = ((uint8_t)ROSGATEWAY_ADV_PROXY_PROXYCOMPONENTWRAPPER_PORT_GETSUM) - inputPortCount;
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[proxyComponentWrapper] writePortGetSum(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    outputPortIndex = ((uint8_t)ROSGATEWAY_ADV_PROXY_PROXYCOMPONENTWRAPPER_PORT_SENDDIFFERENCE) - inputPortCount;
    ...
    (
        ...
        XME_LOG_WARNING,
        "rOSGateway_adv_proxy_proxyComponentWrapper_writeResponseSenderPortSendDifference: Given requestDataHandle is invalid.\n"
    );

    // Write requestDataHandle, which is also the channelID of the request, to the channel ID attribute of the response
    status = rOSGateway_adv_proxy_proxyComponentWrapper_writeOutputPortAttribute
    (
        (rOSGateway_adv_proxy_proxyComponentWrapper_internalPortId_t)ROSGATEWAY_ADV_PROXY_PROXYCOMPONENTWRAPPER_PORT_SENDDIFFERENCE,
        XME_CORE_ATTRIBUTE_KEY_CHANNELID,
        (void*)requestDataHandle,
        (uint32_t)sizeof(xme_core_component_requestDataHandle_t)
    );
    ...
    (
        ...
        XME_LOG_ERROR,
        "%s:%d rOSGateway_adv_proxy_proxyComponentWrapper_writeResponseSenderPortSendDifference: Writing channel ID attribute to port failed. This is attribute is mandatory for request/response communication. Message cannot be delivered.\n",
        __FILE__,
        __LINE__
    );
    ...
    else
    {
        ...
        (
            XME_LOG_ERROR,
            "%s:%d rOSGateway_adv_proxy_proxyComponentWrapper_writePortSendDifference: Writing to port failed. Data Handler returned error code %d.",
            __FILE__,
            __LINE__,
            status
        );
...
)
{
    ...
    else
    {
        ...
        (
            XME_LOG_ERROR,
            "%s:%d rOSGateway_adv_proxy_proxyComponentWrapper_writeOutputPortAttribute: Writing to port failed. Data Handler returned error code %d.",
            __FILE__,
            __LINE__,
            status
        );
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_STATUS_INTERNAL_ERROR,
            XME_LOG_ERROR,
            "[proxyComponentWrapper] CompleteReadOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_STATUS_INTERNAL_ERROR,
            XME_LOG_ERROR,
            "[proxyComponentWrapper] CompleteWriteOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",
        ...
        if (XME_STATUS_BUFFER_TOO_SMALL == status)
        {
            ...
            (
                XME_LOG_WARNING,
                "[proxyComponentWrapper] Data loss on port (interalPortId: %d, dataPacketId: %d), because of full buffer. Oldest value was overwritten.\n",

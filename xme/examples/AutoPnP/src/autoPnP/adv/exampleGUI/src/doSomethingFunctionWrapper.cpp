...
/******************************************************************************/
void
autoPnP_adv_exampleGUI_doSomethingFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            autoPnP_adv_exampleGUI_doSomethingFunction_step((autoPnP_adv_exampleGUI_exampleGUIComponent_config_t* const) functionParameter);

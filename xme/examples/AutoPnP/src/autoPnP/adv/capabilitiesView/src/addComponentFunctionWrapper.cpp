...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/addComponentFunctionWrapper.h"

#include "../include/capabilitiesViewComponentWrapper.h"
#include "../include/addComponentFunction.h"
...
/******************************************************************************/
void
autoPnP_adv_capabilitiesView_addComponentFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            autoPnP_adv_capabilitiesView_addComponentFunction_step((autoPnP_adv_capabilitiesView_capabilitiesViewComponent_config_t* const) functionParameter);

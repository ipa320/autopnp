...
static inputPort_t inputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // capabilitiesView.addComponent
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }  // capabilitiesView.removeComponent
};
...
autoPnP_adv_capabilitiesView_capabilitiesViewComponentWrapper_completeReadOperations(void)
{
    ...
    for (inputPortIndex = 0U; inputPortIndex < inputPortCount; inputPortIndex++)
    {
        ...
        (void) autoPnP_adv_capabilitiesView_capabilitiesViewComponentWrapper_readNextPacket(inputPortIndex);
    }
}
...
)
{
    ...
    inputPortIndex = (uint8_t)AUTOPNP_ADV_CAPABILITIESVIEW_CAPABILITIESVIEWCOMPONENTWRAPPER_PORT_ADDCOMPONENT;
...
)
{
    ...
    inputPortIndex = (uint8_t)AUTOPNP_ADV_CAPABILITIESVIEW_CAPABILITIESVIEWCOMPONENTWRAPPER_PORT_REMOVECOMPONENT;
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_LOG_ERROR,
            "[capabilitiesViewComponentWrapper] CompleteReadOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",

...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/removeComponentFunctionWrapper.h"

#include "../include/capabilitiesViewComponentWrapper.h"
#include "../include/removeComponentFunction.h"
...
/******************************************************************************/
void
autoPnP_adv_capabilitiesView_removeComponentFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            autoPnP_adv_capabilitiesView_removeComponentFunction_step((autoPnP_adv_capabilitiesView_capabilitiesViewComponent_config_t* const) functionParameter);
            autoPnP_adv_capabilitiesView_capabilitiesViewComponentWrapper_completeReadOperations();
        }

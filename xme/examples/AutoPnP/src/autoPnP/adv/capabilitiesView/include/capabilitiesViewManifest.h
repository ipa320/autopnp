...
#ifndef AUTOPNP_ADV_CAPABILITIESVIEW_MANIFEST_H
#define AUTOPNP_ADV_CAPABILITIESVIEW_MANIFEST_H
...
enum
{
    XME_CORE_COMPONENT_TYPE_CAPABILITIESVIEW = 4097U ///< Component type value for capabilitiesView.
};
...
/**
 * \brief  Create manifest for for component type 'capabilitiesView'.
...
#endif // #ifndef AUTOPNP_ADV_CAPABILITIESVIEW_MANIFEST_H

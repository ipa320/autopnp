 ...
 *
 * $Id: randomArrayGenerator.h 3467 2013-05-23 13:48:45Z ruiz $
 */
...
/******************************************************************************/
/**
 * \struct xme_prim_randomArrayGenerator_configStruct_t
 *
...
typedef struct
{
	...
	xme_core_topic_t topic; ///< the generated topic. 
	// private
 ...
 */
xme_status_t
xme_prim_randomArrayGenerator_create
(
	xme_prim_randomArrayGenerator_configStruct_t* config
);
 ...
 */
xme_status_t
xme_prim_randomArrayGenerator_activate
(
	xme_prim_randomArrayGenerator_configStruct_t* config
);
 ...
 */
void
xme_prim_randomArrayGenerator_deactivate
(
	xme_prim_randomArrayGenerator_configStruct_t* config
);
 ...
 */
void
xme_prim_randomArrayGenerator_destroy
(
	xme_prim_randomArrayGenerator_configStruct_t* config
);

 ...
 *
 * $Id: plugAndPlayManagerComponentWrapper.c 7772 2014-03-11 17:03:44Z geisinger $
 */
...
static inputPort_t inputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // pnpManager.inComponentInstanceManifest
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // pnpManager.inPnPLoginRequest
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // pnpManager.inLogoutRequest
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // pnpManager.inLogoutAcknowledgment
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }  // pnpManager.inRemoveComponentRequest
};
...
static outputPort_t outputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // pnpManager.outRuntimeGraph
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // pnpManager.outPnPLoginResponse
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }  // pnpManager.outLogoutNotification
};
...
xme_core_pnp_pnpManagerComponentWrapper_completeReadOperations(void)
{
    ...
    for (inputPortIndex = 0U; inputPortIndex < inputPortCount; inputPortIndex++)
    {
        ...
        (void) xme_core_pnp_pnpManagerComponentWrapper_readNextPacket(inputPortIndex);
    }
}
...
xme_core_pnp_pnpManagerComponentWrapper_completeWriteOperations(void)
{
    ...
    for (outputPortIndex = inputPortCount; outputPortIndex < inputPortCount + outputPortCount; outputPortIndex++)
    {
        ...
        (void) xme_core_pnp_pnpManagerComponentWrapper_writeNextPacket(outputPortIndex);
    }
}
...
)
{
    ...
    (
        ...
        (void*)data,
        (uint32_t)sizeof(xme_core_topic_pnp_componentInstanceManifest_t),
        &bytesRead
    );
...
)
{
    ...
    (
        inputPorts[inputPortIndex].dataPacketId,
        (void*)data,
        (uint32_t)sizeof(xme_core_topic_login_pnpLoginRequest_t),
        &bytesRead
    );
...
)
{
    ...
    inputPortIndex = (uint8_t)XME_CORE_PNP_PNPMANAGERCOMPONENTWRAPPER_PORT_INLOGOUTREQUEST;
    ...
    (
        inputPorts[inputPortIndex].dataPacketId,
        (void*)data,
        (uint32_t)sizeof(xme_core_topic_pnp_logoutRequest_t),
        &bytesRead
    );
...
)
{
    ...
    inputPortIndex = (uint8_t)XME_CORE_PNP_PNPMANAGERCOMPONENTWRAPPER_PORT_INLOGOUTACKNOWLEDGMENT;
    ...
    (
        inputPorts[inputPortIndex].dataPacketId,
        (void*)data,
        (uint32_t)sizeof(xme_core_topic_pnp_logoutAcknowledgment_t),
        &bytesRead
    );
...
)
{
    ...
    inputPortIndex = (uint8_t)XME_CORE_PNP_PNPMANAGERCOMPONENTWRAPPER_PORT_INREMOVECOMPONENTREQUEST;
    ...
    (
        inputPorts[inputPortIndex].dataPacketId,
        (void*)data,
        (uint32_t)sizeof(xme_core_topic_pnp_removeComponentRequest_t),
        &bytesRead
    );
...
)
{
    ...
    (
        ...
        (void*)data,
        (uint32_t)sizeof(xme_core_topic_pnpManager_runtime_graph_model_t)
    );
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[pnpManagerComponentWrapper] writePortOutRuntimeGraph(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    (
        outputPorts[outputPortIndex].dataPacketId,
        (void*)data,
        (uint32_t)sizeof(xme_core_topic_login_pnpLoginResponse_t)
    );
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[pnpManagerComponentWrapper] writePortOutPnPLoginResponse(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    outputPortIndex = ((uint8_t)XME_CORE_PNP_PNPMANAGERCOMPONENTWRAPPER_PORT_OUTLOGOUTNOTIFICATION) - inputPortCount;
    ...
    (
        outputPorts[outputPortIndex].dataPacketId,
        (void*)data,
        (uint32_t)sizeof(xme_core_topic_pnp_logoutNotification_t)
    );
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[pnpManagerComponentWrapper] writePortOutLogoutNotification(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    else
    {
        ...
        (
            XME_LOG_ERROR,
            "%s:%d xme_core_pnp_pnpManagerComponentWrapper_writeOutputPortAttribute: Writing to port failed. Data Handler returned error code %d.",
            __FILE__,
            __LINE__,
            status
        );
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        if (XME_STATUS_BUFFER_TOO_SMALL == status)
        {
            ...
            (
                XME_LOG_WARNING,
                "[pnpManagerComponentWrapper] Data loss on port (interalPortId: %d, dataPacketId: %d), because of full buffer. Oldest value was overwritten.\n",

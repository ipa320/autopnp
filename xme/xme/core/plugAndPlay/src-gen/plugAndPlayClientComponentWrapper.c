 ...
 *
 * $Id: plugAndPlayClientComponentWrapper.c 7772 2014-03-11 17:03:44Z geisinger $
 */
...
static inputPort_t inputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // pnpClient.inLoginAcknowledgment
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }  // pnpClient.inGraph
};
...
static outputPort_t outputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // pnpClient.outManifest
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // pnpClient.outLogoutAcknowledgment
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // pnpClient.outLogoutRequest
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }  // pnpClient.outRemoveComponentRequest
};
...
xme_core_pnp_pnpClientComponentWrapper_completeReadOperations(void)
{
    ...
    for (inputPortIndex = 0U; inputPortIndex < inputPortCount; inputPortIndex++)
    {
        ...
        (void) xme_core_pnp_pnpClientComponentWrapper_readNextPacket(inputPortIndex);
    }
}
...
xme_core_pnp_pnpClientComponentWrapper_completeWriteOperations(void)
{
    ...
    for (outputPortIndex = inputPortCount; outputPortIndex < inputPortCount + outputPortCount; outputPortIndex++)
    {
        ...
        (void) xme_core_pnp_pnpClientComponentWrapper_writeNextPacket(outputPortIndex);
    }
}
...
)
{
    ...
    inputPortIndex = (uint8_t)XME_CORE_PNP_PNPCLIENTCOMPONENTWRAPPER_PORT_INLOGINACKNOWLEDGMENT;
...
)
{
    ...
    inputPortIndex = (uint8_t)XME_CORE_PNP_PNPCLIENTCOMPONENTWRAPPER_PORT_INGRAPH;
...
)
{
    ...
    outputPortIndex = ((uint8_t)XME_CORE_PNP_PNPCLIENTCOMPONENTWRAPPER_PORT_OUTMANIFEST) - inputPortCount;
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[pnpClientComponentWrapper] writePortOutManifest(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    outputPortIndex = ((uint8_t)XME_CORE_PNP_PNPCLIENTCOMPONENTWRAPPER_PORT_OUTLOGOUTACKNOWLEDGMENT) - inputPortCount;
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[pnpClientComponentWrapper] writePortOutLogoutAcknowledgment(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    outputPortIndex = ((uint8_t)XME_CORE_PNP_PNPCLIENTCOMPONENTWRAPPER_PORT_OUTLOGOUTREQUEST) - inputPortCount;
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[pnpClientComponentWrapper] writePortOutLogoutRequest(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    outputPortIndex = ((uint8_t)XME_CORE_PNP_PNPCLIENTCOMPONENTWRAPPER_PORT_OUTREMOVECOMPONENTREQUEST) - inputPortCount;
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[pnpClientComponentWrapper] writePortOutRemoveComponentRequest(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    else
    {
        ...
        (
            XME_LOG_ERROR,
            "%s:%d xme_core_pnp_pnpClientComponentWrapper_writeOutputPortAttribute: Writing to port failed. Data Handler returned error code %d.",
            __FILE__,
            __LINE__,
            status
        );
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_LOG_ERROR,
            "[pnpClientComponentWrapper] CompleteReadOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_STATUS_INTERNAL_ERROR,
            XME_LOG_ERROR,
            "[pnpClientComponentWrapper] CompleteWriteOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",
        ...
        if (XME_STATUS_BUFFER_TOO_SMALL == status)
        {
            ...
            (
                XME_LOG_WARNING,
                "[pnpClientComponentWrapper] Data loss on port (interalPortId: %d, dataPacketId: %d), because of full buffer. Oldest value was overwritten.\n",

 ...
 *
 * $Id: plugAndPlayManagerProcessLogoutRequestsFunctionWrapper.c 7631 2014-02-28 13:27:17Z wiesmueller $
 */
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            xme_core_pnp_pnpManagerProcessLogoutRequestsFunction_step((xme_core_pnp_pnpManagerComponent_config_t* const) functionParameter);

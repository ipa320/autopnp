 ...
 *
 * $Id: plugAndPlayClientSendManifestFunctionWrapper.c 7631 2014-02-28 13:27:17Z wiesmueller $
 */
...
/******************************************************************************/
void
xme_core_pnp_pnpClientSendManifestFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            xme_core_pnp_pnpClientSendManifestFunction_step((xme_core_pnp_pnpClientComponent_config_t* const) functionParameter);

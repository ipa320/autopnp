 ...
 *
 * $Id: loginManagerComponentWrapper.c 7772 2014-03-11 17:03:44Z geisinger $
 */
...
static inputPort_t inputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // loginManager.inLoginRequest
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // loginManager.inPnPLoginResponse
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }  // loginManager.inLogoutNotification
};
...
static outputPort_t outputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // loginManager.outPnPLoginRequest
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }  // loginManager.outLoginResponse
};
...
xme_core_login_loginManagerComponentWrapper_completeReadOperations(void)
{
    ...
    for (inputPortIndex = 0U; inputPortIndex < inputPortCount; inputPortIndex++)
    {
        ...
        (void) xme_core_login_loginManagerComponentWrapper_readNextPacket(inputPortIndex);
    }
}
...
xme_core_login_loginManagerComponentWrapper_completeWriteOperations(void)
{
    ...
    for (outputPortIndex = inputPortCount; outputPortIndex < inputPortCount + outputPortCount; outputPortIndex++)
    {
        ...
        (void) xme_core_login_loginManagerComponentWrapper_writeNextPacket(outputPortIndex);
    }
}
...
)
{
    ...
    inputPortIndex = (uint8_t)XME_CORE_LOGIN_LOGINMANAGERCOMPONENTWRAPPER_PORT_INLOGOUTNOTIFICATION;
...
)
{
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[loginManagerComponentWrapper] writePortOutPnPLoginRequest(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[loginManagerComponentWrapper] writePortOutLoginResponse(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    else
    {
        ...
        (
            XME_LOG_ERROR,
            "%s:%d xme_core_login_loginManagerComponentWrapper_writeOutputPortAttribute: Writing to port failed. Data Handler returned error code %d.",
            __FILE__,
            __LINE__,
            status
        );
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        if (XME_STATUS_BUFFER_TOO_SMALL == status)
        {
            ...
            (
                XME_LOG_WARNING,
                "[loginManagerComponentWrapper] Data loss on port (interalPortId: %d, dataPacketId: %d), because of full buffer. Oldest value was overwritten.\n",

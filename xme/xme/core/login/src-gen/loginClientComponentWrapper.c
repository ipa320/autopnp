 ...
 *
 * $Id: loginClientComponentWrapper.c 7772 2014-03-11 17:03:44Z geisinger $
 */
...
static inputPort_t inputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } } // loginClient.inResponse
};
...
static outputPort_t outputPorts[] = {
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }, // loginClient.outRequest
    {XME_CORE_DATAMANAGER_DATAPACKETID_INVALID, { 0U } }  // loginClient.outLoginAcknowledgment
};
...
xme_core_login_loginClientComponentWrapper_completeReadOperations(void)
{
    ...
    for (inputPortIndex = 0U; inputPortIndex < inputPortCount; inputPortIndex++)
    {
        ...
        (void) xme_core_login_loginClientComponentWrapper_readNextPacket(inputPortIndex);
    }
}
...
xme_core_login_loginClientComponentWrapper_completeWriteOperations(void)
{
    ...
    for (outputPortIndex = inputPortCount; outputPortIndex < inputPortCount + outputPortCount; outputPortIndex++)
    {
        ...
        (void) xme_core_login_loginClientComponentWrapper_writeNextPacket(outputPortIndex);
    }
}
...
)
{
    ...
    inputPortIndex = (uint8_t)XME_CORE_LOGIN_LOGINCLIENTCOMPONENTWRAPPER_PORT_INRESPONSE;
    ...
    (
        ...
        (void*)data,
        (uint32_t)sizeof(xme_core_topic_login_loginResponse_t),
        &bytesRead
    );
...
)
{
    ...
    outputPortIndex = ((uint8_t)XME_CORE_LOGIN_LOGINCLIENTCOMPONENTWRAPPER_PORT_OUTREQUEST) - inputPortCount;
    ...
    (
        ...
        (void*)data,
        (uint32_t)sizeof(xme_core_topic_login_loginRequest_t)
    );
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[loginClientComponentWrapper] writePortOutRequest(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    outputPortIndex = ((uint8_t)XME_CORE_LOGIN_LOGINCLIENTCOMPONENTWRAPPER_PORT_OUTLOGINACKNOWLEDGMENT) - inputPortCount;
    ...
    (
        outputPorts[outputPortIndex].dataPacketId,
        (void*)data,
        (uint32_t)sizeof(xme_core_topic_login_loginAcknowledgment_t)
    );
    ...
    else
    {
        ...
        XME_LOG(XME_LOG_ERROR,
            "[loginClientComponentWrapper] writePortOutLoginAcknowledgment(): Writing to port failed. Data Handler returned error code %d.\n",
            status);
    }
...
)
{
    ...
    else
    {
        ...
        (
            XME_LOG_ERROR,
            "%s:%d xme_core_login_loginClientComponentWrapper_writeOutputPortAttribute: Writing to port failed. Data Handler returned error code %d.",
            __FILE__,
            __LINE__,
            status
        );
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_LOG_ERROR,
            "[loginClientComponentWrapper] CompleteReadOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",
...
)
{
...
#endif // #ifdef XME_MULTITHREAD
    {
        ...
        (
            ...
            XME_STATUS_INTERNAL_ERROR,
            XME_LOG_ERROR,
            "[loginClientComponentWrapper] CompleteWriteOperation for port (interalPortId: %d, dataPacketId: %d) returned error code %d.\n",
        ...
        if (XME_STATUS_BUFFER_TOO_SMALL == status)
        {
            ...
            (
                XME_LOG_WARNING,
                "[loginClientComponentWrapper] Data loss on port (interalPortId: %d, dataPacketId: %d), because of full buffer. Oldest value was overwritten.\n",

 ...
 *
 * $Id: loginManagerProcessRequestFunctionWrapper.c 7631 2014-02-28 13:27:17Z wiesmueller $
 */
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            xme_core_login_loginManagerProcessRequestFunction_step((xme_core_login_loginManagerComponent_config_t* const) functionParameter);

 ...
 *
 * $Id: loginClientProcessResponseFunctionWrapper.c 7631 2014-02-28 13:27:17Z wiesmueller $
 */
...
/******************************************************************************/
void
xme_core_login_loginClientProcessResponseFunctionWrapper_execute
(
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            xme_core_login_loginClientProcessResponseFunction_step((xme_core_login_loginClientComponent_config_t* const) functionParameter);
            xme_core_login_loginClientComponentWrapper_completeReadOperations();
            xme_core_login_loginClientComponentWrapper_completeWriteOperations();
        }

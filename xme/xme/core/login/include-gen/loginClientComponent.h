 ...
 *
 * $Id: loginClientComponent.h 7483 2014-02-18 16:14:01Z wiesmueller $
 */

/**
 * \file
 *         Header file for loginClient component.
 *
 * \author
...
#ifndef XME_CORE_LOGIN_LOGINCLIENTCOMPONENT_H
#define XME_CORE_LOGIN_LOGINCLIENTCOMPONENT_H
...
// PROTECTED REGION ID(XME_CORE_LOGIN_LOGINCLIENTCOMPONENT_H_INCLUDES) ENABLED START
...
// PROTECTED REGION ID(XME_CORE_LOGIN_LOGINCLIENTCOMPONENT_H_DEFINES) ENABLED START
...
// PROTECTED REGION ID(XME_CORE_LOGIN_LOGINCLIENTCOMPONENT_H_TYPE_DEFINITIONS) ENABLED START

// PROTECTED REGION END

/**
 * \typedef xme_core_login_loginClientComponent_config_t
 *
...
typedef struct
{
    // PROTECTED REGION ID(XME_CORE_LOGIN_LOGINCLIENTCOMPONENT_H_CONFIG) ENABLED START

    char dummy; ///< TODO: Dummy field, replace with actual component configuration.

    // PROTECTED REGION END
} xme_core_login_loginClientComponent_config_t;
...
// PROTECTED REGION ID(XME_CORE_LOGIN_LOGINCLIENTCOMPONENT_H_PROTOTYPES) ENABLED START

// PROTECTED REGION END

XME_EXTERN_C_END

#endif // #ifndef XME_CORE_LOGIN_LOGINCLIENTCOMPONENT_H

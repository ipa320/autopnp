 ...
 *
 * $Id: udpReceiveWayPointFunctionWrapper.c 6157 2013-12-18 16:17:39Z geisinger $
 */
...
)
{
    ...
    while(XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            (void) xme_wp_udp_udpReceive_run((xme_wp_waypoint_instanceId_t)(uintptr_t)functionVariantId);
        }

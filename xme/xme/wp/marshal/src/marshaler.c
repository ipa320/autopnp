 ...
 *
 * $Id: marshaler.c 6684 2014-02-07 14:34:26Z geisinger $
 */
...
{
    XME_HAL_TABLE_INIT(xme_wp_marshal_marshaler_configurationTable);
...
)
{
    ...
    xme_wp_marshal_marshaler_configurationItem_t* item = NULL;
...
)
{
    ...
    // TODO: Uncomment this when issue #3315 is resolved
//    XME_CHECK
//    (
...
//    );
    ...
    configurationItemHandle = XME_HAL_TABLE_ADD_ITEM(xme_wp_marshal_marshaler_configurationTable);
...
)
{
    ...
    status = XME_HAL_TABLE_REMOVE_ITEM(xme_wp_marshal_marshaler_configurationTable, (xme_hal_table_rowHandle_t)(instanceId));
...
{
    XME_HAL_TABLE_FINI(xme_wp_marshal_marshaler_configurationTable);

 ...
 *
 * $Id: channelInjectorWayPointFunctionWrapper.c 6684 2014-02-07 14:34:26Z geisinger $
 */
...
)
{
    ...
    while(XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            (void) xme_wp_channel_channelInjector_run((xme_wp_waypoint_instanceId_t)(uintptr_t)functionVariantId);
        }

...
#
# $Id: XMEUtils.cmake 5155 2013-09-24 11:44:03Z geisinger $
#
...
#                 [ INCLUDE_PATH ( [ VALUE ] <includepath1> [ <includepath2> ... ] | VALUE_OF <varname1> [ <varname2> ... ] ) ]
#                 [ LIBRARY_PATH ( [ VALUE ] <librarypath1> [ <librarypath2> ... ] | VALUE_OF <varname1> [ <varname2> ... ] ) ]
#                 [ LINK [ CONFIGURATION ( DEBUG | OPTIMIZED | GENERAL ) ] ( [ VALUE ] <library1> [ <library2> ... ] | VALUE_OF <varname1> [ <varname2> ... ] ) ]
...
#                                        header files to use for building the component.
#
#             SOURCES <source1> [ <source2> ... ]
#                                        The "SOURCES" keyword indicates that the following items shall be interpreted as
#                                        source files to use for building the component.
#
#             DEPENDS <dependency1> [ <dependency2> ... ]
#                                        The "DEPENDS" keyword indicate that the following items shall be interpreted as
#                                        names of other components that are required for this component to work properly.
#                                        This means that the new component will be linked against the referenced component
#                                        and that include directories of the referenced component will be available in the
#                                        new component.
#
#             PACKAGES <package1> [ <package2> ... ]
...
#                                         - If the "VALUE" keyword if present in front of an item, or the "VALUE_OF" keyword
#                                           is not present in between the "INCLUDE_PATH" keyword and the respective item, the
#                                           name of an include path to use when building the component.
#
#             LIBRARY_PATH ( [ VALUE ] <librarypath1> [ <librarypath2> ... ] | VALUE_OF <varname1> [ <varname2> ... ] )
...
#                                           the "PACKAGES" keyword has been found.
#                                         - If the "VALUE" keyword if present in front of an item, or the "VALUE_OF" keyword
#                                           is not present in between the "LIBRARY_PATH" keyword and the respective item, the
#                                           name of a library path to use when building the component.
#
#             LINK [ CONFIGURATION ( DEBUG | OPTIMIZED | GENERAL ) ] ( [ VALUE ] <library1> [ <library2> ... ] | VALUE_OF <varname1> [ <varname2> ... ] )
...
#                                           the "PACKAGES" keyword has been found.
#                                         - If the "VALUE" keyword if present in front of an item, or the "VALUE_OF" keyword
#                                           is not present in between the "LINK" keyword and the respective item, the name of
#                                           a linker library (static or dynamic) to use when building the component.
...
macro (xme_add_component)
	...
	set (__USAGE__ "Usage: xme_add_component ( <component-name> [ <header.h> ... | <source.c> ... | <dependency> ... ] [ HEADERS <header1> [ <header2> ...] ] [ SOURCES <source1> [ <source2> ... ] ] [ DEPENDS  <dependency1> [ <dependency2> ... ] ] [ PACKAGES <package1> [ <package2> ... ] ] [ INCLUDE_PATH ( [ VALUE ] <includepath1> [ <includepath2> ... ] | VALUE_OF <varname1> [ <varname2> ... ] ) ] [ LIBRARY_PATH ( [ VALUE ] <librarypath1> [ <librarypath2> ... ] | VALUE_OF <varname1> [ <varname2> ... ] ) ] [ LINK [ CONFIGURATION ( DEBUG | OPTIMIZED | GENERAL ) ] ( [ VALUE ] <library1> [ <library2> ... ] | VALUE_OF <varname1> [ <varname2> ... ] ) ] )")
	...
	if (__COMP_NAME__ STREQUAL "HEADERS" OR __COMP_NAME__ STREQUAL "SOURCES" OR
		...
		__COMP_NAME__ STREQUAL "INCLUDE_PATH" OR __COMP_NAME__ STREQUAL "LIBRARY_PATH" OR
		__COMP_NAME__ STREQUAL "LINK")
	...
	foreach (ARG ${__ARGS__})
        ...
        elseif (__EXPECT_PROPERTY_VALUE__)
			...
			elseif (__MODE__ EQUAL 5)
				...
				set (__BYVALUE__ TRUE) # Reset to default
    ...
    # Add build system related files (currently only CMakeLists.txt file)
...
macro (xme_add_executable TARGET)
	...
	add_executable (${TARGET} ${__EXCLUDE_FROM_ALL__} ${__EXISTING_LIST__} ${__GENERATED_LIST__})
...
function (_xme_link_thirdparty_dependencies TARGET COMP)
    ...
    foreach (__LNK__ ${__LINKS__})
        if (__IS_INFO__)
            ...
            #  - <by-value> is a flag (TRUE or FALSE) specifying whether the subsequent value
            #    is a literal value (TRUE) or the name of a variable (FALSE)
            #  - <configuration> is the name of the configuration (DEBUG, OPTIMIZED or GENERAL)
            #    where the linker library is to be applied
            string (REGEX REPLACE "\\|.*$" "" __BY_VALUE__ ${__LNK__})
            string (REGEX REPLACE "^[^\\|]+\\|" "" __CONFIGURATION__ ${__LNK__})

            if (__BY_VALUE__ STREQUAL "TRUE" OR __BY_VALUE__ STREQUAL "FALSE")
            else (__BY_VALUE__ STREQUAL "TRUE" OR __BY_VALUE__ STREQUAL "FALSE")
                message (FATAL_ERROR "Invalid value for __BY_VALUE__ passed in linker libraries property!")
            endif (__BY_VALUE__ STREQUAL "TRUE" OR __BY_VALUE__ STREQUAL "FALSE")
...
macro (xme_callback_execute CALLBACK_NAME)
	...
	# otherwise CMake will re-run when due to a missing build dependency
	# when we call 'make' subsequently. Since CMake processes the file
	# immediatly upon include() and the file if overwritten every
	# time before it is loaded, this is not a problem.

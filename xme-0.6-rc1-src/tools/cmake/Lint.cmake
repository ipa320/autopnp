...
#
# $Id: Lint.cmake 5162 2013-09-25 10:04:21Z geisinger $
#
...
function (xme_add_lint COMPONENT_NAME)
    ...
    if (LINT_FOUND)
        ...
        foreach (_include_path ${__include_paths})
            list (APPEND _lint_include_path "-i${_include_path}")
        ...
        if (CMAKE_BUILD_TYPE STREQUAL "Debug")
            set (__parsing "${__parsing} ${CMAKE_C_FLAGS_DEBUG} ${CMAKE_CXX_FLAGS_DEBUG}")
        elseif (CMAKE_BUILD_TYPE STREQUAL "Release")
            set (__parsing "${__parsing} ${CMAKE_C_FLAGS_RELEASE} ${CMAKE_CXX_FLAGS_RELEASE}")
        elseif (CMAKE_BUILD_TYPE STREQUAL "MinSizeRel")
            set (__parsing "${__parsing} ${CMAKE_C_FLAGS_MINSIZEREL} ${CMAKE_CXX_FLAGS_MINSIZEREL}")
        elseif (CMAKE_BUILD_TYPE STREQUAL "RelWithDebInfo")
            set (__parsing "${__parsing} ${CMAKE_C_FLAGS_RELWITHDEBINFO} ${CMAKE_CXX_FLAGS_RELWITHDEBINFO}")
        else ()
            message(FATAL_ERROR "Unsupported CMAKE_BUILD_TYPE value '${CMAKE_BUILD_TYPE}'!")
        endif ()
        ...
        foreach (_definition ${__compile_defines})
            list (APPEND _lint_defines "-d${_definition}")
...
if (NOT CMAKE_HOST_WIN32)
    if (NOT LINT_FOUND)
        ...
        if (LINT_EXECUTABLE)
            ...
            set (LINT_OPTIONS "-i${LINT_FILE_PATH}" "co-gcc.lnt"
                              "-i${LINT_XME_FILE_PATH}" "xme.lnt"
            ...
            if (LINT_EXECUTABLE)
                ...
                set (LINT_OPTIONS "+weak"
                                  ...
                                  "-warnposix"
                                  "+show-summary"
                                  "+line-len 160" #-linelen 999 for DevStudio
                                  "-Dlint"

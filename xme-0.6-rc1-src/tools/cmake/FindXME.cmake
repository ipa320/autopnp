...
#
# $Id: FindXME.cmake 4901 2013-09-02 09:49:57Z geisinger $
#
...
if (NOT ${XME_TARGET_IDENTIFIER_DEFINED})
	# Check if XME_TARGET_IDENTIFIER has been set. This is useful in order
	# to selection of a specific build host on the command line using
	...
	if (DEFINED XME_TARGET_IDENTIFIER)
	...
	else (DEFINED XME_TARGET_IDENTIFIER)
		...
		xme_message (NOTE "XME_TARGET_IDENTIFIER not defined. Assuming '${CMAKE_SYSTEM_NAME}' and setting to '${XME_TARGET_IDENTIFIER}'.")
	endif (DEFINED XME_TARGET_IDENTIFIER)

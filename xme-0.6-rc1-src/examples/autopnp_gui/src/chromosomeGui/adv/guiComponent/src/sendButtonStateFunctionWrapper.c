...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/sendButtonStateFunctionWrapper.h"

#include "../include/guiComponentComponentWrapper.h"
#include "../include/sendButtonStateFunction.h"
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            chromosomeGui_adv_guiComponent_sendButtonStateFunction_step(functionParameter);
            chromosomeGui_adv_guiComponent_guiComponentComponentWrapper_completeWriteOperations();
            chromosomeGui_adv_guiComponent_guiComponentComponentWrapper_completeReadOperations();
        }

...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/doSomethingFunctionWrapper.h"

#include "../include/componentOneComponentWrapper.h"
#include "../include/doSomethingFunction.h"
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            chromosomeGui_adv_componentOne_doSomethingFunction_step(functionParameter);

...
/***   Includes                                                             ***/
/******************************************************************************/
#include "../include/publishTextFunctionWrapper.h"

#include "../include/componentOneComponentWrapper.h"
#include "../include/publishTextFunction.h"
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            chromosomeGui_adv_componentOne_publishTextFunction_step(functionParameter);
            chromosomeGui_adv_componentOne_componentOneComponentWrapper_completeWriteOperations();
            chromosomeGui_adv_componentOne_componentOneComponentWrapper_completeReadOperations();
        }

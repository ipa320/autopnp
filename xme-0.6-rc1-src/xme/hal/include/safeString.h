 ...
 *
 * $Id: safeString.h 4595 2013-08-07 13:49:46Z ruiz $
 */
 ...
 * \param  ... Additional parameters as per format.
 *
 ...
 *
 * \param  format Format string as used in printf().
 * \param  args Additional parameters as an argument list as per format.
 *
 * \return On success, returns the total number of characters that would be
 *         generated if the string was to be formatted according to the
 *         specified format string, not including the terminating null
 ...
 *
 * buffer may be NULL if sizeInBytes is zero.
 *
 ...
 * \param  sizeInBytes The size of the destination buffer, in bytes.
 * \param  format Format string as used in printf().
 * \param  ... Additional parameters as per format.
 *
 ...
 * \param  sizeInBytes The size of the destination buffer, in bytes.
 * \param  format Format string as used in printf().
 * \param  args Additional parameters as per format.
 *
 * \return On success, returns the total number of characters written, not
 *         including the terminating null character. On error, returns a
 *         negative number. On platforms where this is supported, the function
 ...
 *
 * Unlike the strncpy() function from the standard library, the resulting
 ...
 *
 * The resulting string is guaranteed to be NULL-terminated if sizeInBytes is
 * larger than zero.
 *

 ...
 *
 * $Id: interfaceTestLinkedList.cpp 5040 2013-09-11 10:57:37Z geisinger $
 */
...
{
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_singlyLinkedList_addItemOrdered(&myList, NULL, &alwaysAfterInsertionCallback, (void*) 0x1234)));
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_singlyLinkedList_addItemOrdered(&myList, (void*) 0x1234, &alwaysAfterInsertionCallback, (void*) 0x1234)));
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_singlyLinkedList_addItemOrdered(&myList, NULL, &alwaysAfterInsertionCallback, (void*) 0x1234)));
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_singlyLinkedList_addItemOrdered(&myList, NULL, &alwaysAfterInsertionCallback, (void*) 0x1234)));
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_singlyLinkedList_addItemOrdered(&myList, (void*) 0x5678, &alwaysAfterInsertionCallback, (void*) 0x1234)));
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_singlyLinkedList_addItemOrdered(&myList, NULL, &alwaysAfterInsertionCallback, (void*) 0x1234)));
}
...
{
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_doublyLinkedList_addItemOrdered(&myList, NULL, &alwaysAfterInsertionCallback, (void*) 0x1234)));
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_doublyLinkedList_addItemOrdered(&myList, (void*) 0x1234, &alwaysAfterInsertionCallback, (void*) 0x1234)));
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_doublyLinkedList_addItemOrdered(&myList, NULL, &alwaysAfterInsertionCallback, (void*) 0x1234)));
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_doublyLinkedList_addItemOrdered(&myList, NULL, &alwaysAfterInsertionCallback, (void*) 0x1234)));
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_doublyLinkedList_addItemOrdered(&myList, (void*) 0x5678, &alwaysAfterInsertionCallback, (void*) 0x1234)));
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(XME_STATUS_ABORTED, xme_hal_doublyLinkedList_addItemOrdered(&myList, NULL, &alwaysAfterInsertionCallback, (void*) 0x1234)));
}

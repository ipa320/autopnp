 ...
 *
 * $Id: smokeTestLinkedList.cpp 5040 2013-09-11 10:57:37Z geisinger $
 */
...
{
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(0U, xme_hal_singlyLinkedList_removeItem(NULL, (void*) 0x1234, false)));
}

TEST_F(SinglyLinkedListSmokeTest, removeAllItemsFromNullList)
{
    EXPECT_NO_XME_ASSERTION_FAILURES(EXPECT_EQ(0U, xme_hal_singlyLinkedList_removeItem(NULL, (void*) 0x1234, true)));
}
...
#ifdef DEBUG
    // Assertion failure expected
    EXPECT_XME_ASSERTION_FAILURE(EXPECT_EQ(0U, xme_hal_singlyLinkedList_removeItem(&myList, NULL, true)));
#else // #ifdef DEBUG
    // No checks in release mode
#endif // #ifdef DEBUG
}

 ...
 *
 * $Id: interfaceTestSafeString.cpp 4597 2013-08-07 14:18:28Z ruiz $
 */
...
/***   Includes                                                             ***/
/******************************************************************************/
// Make sure PRI* macros are defined by <inttypes.h>
...
{
    xme_hal_safeString_strncat(NULL, "", 0);
}

TEST_F(SafeStringInterfaceTest, strncatWithZeroSize)
{
    buf[0] = 0;
    xme_hal_safeString_strncat(buf, "abc", 0);
    EXPECT_STREQ("", buf);
}
...
{
    buf[0] = 0;
    xme_hal_safeString_strncat(buf, "", 1);
    EXPECT_STREQ("", buf);
}
...
{
    buf[0] = 0;
    xme_hal_safeString_strncat(buf, "a", 2);
    EXPECT_STREQ("a", buf);
}
...
{
    buf[0] = 0;
    xme_hal_safeString_strncat(buf, "fortiss", 4);
    EXPECT_STREQ("for", buf);
}
...
{
    buf[0] = 0;
    xme_hal_safeString_strncat(buf, "fortiss", 8);
    EXPECT_STREQ("fortiss", buf);
}
...
{
    buf[0] = 0;
    xme_hal_safeString_strncat(buf, "fortiss", 16);
    EXPECT_STREQ("fortiss", buf);
}
...
TEST_F(SafeStringInterfaceTest, strncatWithShortStringAndEmptyString)
{
    buf[0] = 'a';
    buf[1] = 0;
    xme_hal_safeString_strncat(buf, "", 2);
    EXPECT_STREQ("a", buf);
}
...
TEST_F(SafeStringInterfaceTest, strncatWithShortStringAndShortString)
{
    buf[0] = 'a';
    buf[1] = 0;
    xme_hal_safeString_strncat(buf, "b", 3);
    EXPECT_STREQ("ab", buf);
}
...
TEST_F(SafeStringInterfaceTest, strncatWithShortStringAndPartialString)
{
    buf[0] = '*';
    buf[1] = 0;
    xme_hal_safeString_strncat(buf, "fortiss", 5);
    EXPECT_STREQ("*for", buf);
}
...
TEST_F(SafeStringInterfaceTest, strncatWithShortStringAndFullString)
{
    buf[0] = '*';
    buf[1] = 0;
    xme_hal_safeString_strncat(buf, "fortiss", 9);
    EXPECT_STREQ("*fortiss", buf);
}

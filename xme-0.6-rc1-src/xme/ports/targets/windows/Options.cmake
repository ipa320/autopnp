...
# Check if XME_CONFIG_TARGET_CPU has been set. This is useful in order to selection of
# a specific processor type on the command line using cmake -DXME_CONFIG_TARGET_CPU=<...>. 
...
if(${XME_CONFIG_TARGET_CPU_DEFINED})
	...
	if(${XME_TARGET_CPU_DEFINED})
		...
		message (STATUS "XME_CONFIG_TARGET_CPU not defined. Assuming: 'CMAKE internals' and setting to '${XME_CONFIG_TARGET_CPU}'.")
...
else (${XME_CONFIG_TARGET_CPU} STREQUAL "x86")
	message(FATAL_ERROR "Do not know how to handle the given target cpu with ${XME_CONFIG_TARGET_CPU}." )
...
xme_add_subdirectory(../../software/os/windows FALSE "Options.cmake")

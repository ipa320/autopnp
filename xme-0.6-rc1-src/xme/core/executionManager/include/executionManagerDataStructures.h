 ...
 *
 * $Id: executionManagerDataStructures.h 5165 2013-09-25 10:14:25Z camek $
 */
...
typedef struct xme_core_exec_functionDescriptor_s
{
    ...
    void* taskArgs; ///< Task arguments: currently used to pass the pointer to the wrapper itself
    ...
    void* initParam;                            ///< function initialization parameter

 ...
 *
 * $Id: plugAndPlayClientComponentWrapper.c 4961 2013-09-04 12:26:40Z ruiz $
 */
...
)
{
    ...
    else
    {
        ...
        (
            XME_LOG_ERROR,
            "%s:%d xme_core_pnp_pnpClientComponentWrapper_writePortOutManifest: Error when writing to port. Data handler returned error code %d.",
            __FILE__,
            __LINE__,
            returnValue
        );

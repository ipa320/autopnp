 ...
 *
 * $Id: plugAndPlayManagerInternalTypes.h 5214 2013-09-27 14:24:34Z ruiz $
 */
...
typedef struct
{
    ...
    xme_core_pnp_pnpManager_nodeComponentInstance_status_t status; ///< the instance current status. 
}

 ...
 *
 * $Id: smokeTestNodeRegistryController.cpp 4374 2013-07-26 08:25:02Z geisinger $
 */
...
{
    xme_core_directory_nodeRegistryController_nodeInterfaceIterator_t *iterator=NULL;
    EXPECT_EQ(XME_STATUS_NOT_FOUND, xme_core_directory_nodeRegistryController_initNodeInterfaceIterator(XME_CORE_NODE_INVALID_NODE_ID, XME_COM_INTERFACE_ADDRESS_TYPE_IPV4, &iterator));
    EXPECT_TRUE(NULL==iterator);
}
...
{
    xme_core_directory_nodeRegistryController_nodeInterfaceIterator_t *iterator=NULL;
    EXPECT_EQ(XME_STATUS_NOT_FOUND, xme_core_directory_nodeRegistryController_initNodeInterfaceIterator(XME_CORE_NODE_INVALID_NODE_ID, XME_COM_INTERFACE_ADDRESS_TYPE_INVALID, &iterator));
    EXPECT_TRUE(NULL==iterator);
}

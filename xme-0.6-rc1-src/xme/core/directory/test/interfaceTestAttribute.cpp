 ...
 *
 * $Id: interfaceTestAttribute.cpp 5107 2013-09-18 15:53:16Z geisinger $
 */
...
TEST_F(AttributeInterfaceTest, createAndRemoveAttributeSets)
{
    ...
    ASSERT_EQ(XME_STATUS_INVALID_HANDLE, xme_core_directory_attribute_removeAttributeSet(genericAttributeSetHandle1));
}

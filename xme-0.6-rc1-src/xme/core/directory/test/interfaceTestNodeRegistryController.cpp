 ...
 *
 * $Id: interfaceTestNodeRegistryController.cpp 5106 2013-09-18 15:16:10Z ruiz $
 */
...
{
    ASSERT_FALSE(xme_core_directory_nodeRegistryController_isNodeGuidRegistered(0u));
    ASSERT_FALSE(xme_core_directory_nodeRegistryController_isNodeGuidRegistered(5u));
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_directory_nodeRegistryController_registerNode(node1, "node1", 5u));
    ASSERT_TRUE(xme_core_directory_nodeRegistryController_isNodeGuidRegistered(5u));
    ASSERT_FALSE(xme_core_directory_nodeRegistryController_isNodeGuidRegistered(6u));
}
...
TEST_F(NodeRegistryControllerAddInterfaceTest, AddInterfaceAddingTwiceTheInterface)
{
    ...
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_directory_nodeRegistryController_addInterface(node1, *nodeIntf1));
#if 0
    // TODO: Change Request #3418. Include this in coverage. 

 ...
 *
 * $Id: interfaceTestBroker.cpp 5207 2013-09-27 11:58:51Z ruiz $
 */
...
TEST_F(BrokerInterfaceTest, BrokerPnPManagerInterfaceComplete)
{
    ...
    ASSERT_EQ(1, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*dataPacketDesc));
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getFunctionDataPackets(componentId, functionId1, functionVariantId1, functDesc));
    ASSERT_EQ(1, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*functDesc));
    XME_HAL_SINGLYLINKEDLIST_INIT(*dataPacketDesc);
    ...
    ASSERT_EQ(1, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*dataPacketDesc));
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getFunctionDataPackets(componentId, functionId1, functionVariantId1, functDesc));
    ASSERT_EQ(2, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*functDesc));
    XME_HAL_SINGLYLINKEDLIST_INIT(*dataPacketDesc);
    XME_HAL_SINGLYLINKEDLIST_INIT(*functDesc);
    ...
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getFunctionDataPackets(componentId, functionId1, functionVariantId1, functDesc));
    ASSERT_EQ(2, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*functDesc)); // two associated datapackets
    XME_HAL_SINGLYLINKEDLIST_INIT(*functDesc);
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getFunctionDataPackets(componentId, functionId2, functionVariantId2, functDesc));
    ASSERT_EQ(3, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*functDesc)); // three associated datapackets
    XME_HAL_SINGLYLINKEDLIST_INIT(*functDesc);
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getFunctionDataPackets(componentId, functionId3, functionVariantId3, functDesc));
    ASSERT_EQ(4, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*functDesc)); // four associated datapackets
    XME_HAL_SINGLYLINKEDLIST_INIT(*functDesc);
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getFunctionDataPackets(componentId, functionId3, functionVariantId4, functDesc));
    ASSERT_EQ(1, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*functDesc)); // four associated datapackets
    XME_HAL_SINGLYLINKEDLIST_INIT(*functDesc);

    // 7. testing of getDataPacketFunctions
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getDataPacketFunctions(inDataPacketId1, dataPacketDesc));
    ASSERT_EQ(3, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*dataPacketDesc)); // three associated functions
    XME_HAL_SINGLYLINKEDLIST_INIT(*dataPacketDesc);
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getDataPacketFunctions(inDataPacketId2, dataPacketDesc));
    ASSERT_EQ(2, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*dataPacketDesc)); // two associated functions
    XME_HAL_SINGLYLINKEDLIST_INIT(*dataPacketDesc);
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getDataPacketFunctions(inDataPacketId3, dataPacketDesc));
    ASSERT_EQ(1, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*dataPacketDesc)); // one associated function
    XME_HAL_SINGLYLINKEDLIST_INIT(*dataPacketDesc);
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getDataPacketFunctions(inDataPacketId4, dataPacketDesc));
    ASSERT_EQ(3, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*dataPacketDesc)); // two associated functions
    XME_HAL_SINGLYLINKEDLIST_INIT(*dataPacketDesc);
    ...
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getFunctionDataPackets(componentId, functionId3, functionVariantId3, functDesc));
    ASSERT_EQ(3, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*functDesc)); // only three associated datapackets left
    XME_HAL_SINGLYLINKEDLIST_INIT(*functDesc);
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getDataPacketFunctions(inDataPacketId1, dataPacketDesc));
    ASSERT_EQ(2, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*dataPacketDesc)); // only two associated functions left
    XME_HAL_SINGLYLINKEDLIST_INIT(*dataPacketDesc);
    ...
    XME_HAL_SINGLYLINKEDLIST_INIT(*functDesc);
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_broker_getFunctionDataPackets(componentId, functionId3, functionVariantId4, functDesc));
    ASSERT_EQ(1, XME_HAL_SINGLYLINKEDLIST_ITEM_COUNT(*functDesc)); // only three associated datapackets left
    XME_HAL_SINGLYLINKEDLIST_INIT(*functDesc);

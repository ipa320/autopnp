 ...
 *
 * $Id: brokerInternalTypes.h 5090 2013-09-17 12:15:53Z ruiz $
 */
...
/**
 * \struct xme_core_broker_functionDescriptionTable_t
 *
 * \brief Table type associating functions and parameters.
 */
...
/**
 * \struct xme_core_broker_dataSubscriberTable_t
 *
 * \brief Table type associating data packets and associated subscriber
 *        functions.
 */
typedef XME_HAL_TABLE
(

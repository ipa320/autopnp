 ...
 *
 * $Id: integrationTestDataHandlerShadow.cpp 5117 2013-09-19 10:13:40Z wiesmueller $
 */
...
class Application {
    public:
        Application(xme_core_component_t componentIdentifier) :
...
TEST_F(DataHandlerShadowIntegrationTest, writeElementsAndReadWithOffset)
{
    ...
    Application *appA = new Application((xme_core_component_t) rand());
...
//void testShadowDatabaseTestsystemInterface(bool testRTEPorts)
{
  ...
  */
  ...
  // 2nd application
  Application *appB = new Application((xme_core_component_t) rand());
  /*appB->inportCount = 1;
  appB->outportCount = 0;*/
  ...
  // 3rd application
  Application *appC = new Application((xme_core_component_t) rand());
  //appC->inportCount = 1;
  //appC->outportCount = 0;

 ...
 *
 * $Id: interfaceTestLoginManager.cpp 4997 2013-09-06 08:24:52Z ruiz $
 */
...
{
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_login_loginManager_checkAlreadyLoggedIn(guid1));
    ASSERT_EQ(XME_STATUS_SUCCESS, xme_core_login_loginManager_checkAlreadyLoggedIn(guid2));
}

 ...
 *
 * $Id: loginClientComponentWrapper.c 4961 2013-09-04 12:26:40Z ruiz $
 */
...
)
{
    ...
    else
    {
        ...
        (
            XME_LOG_ERROR,
            "%s:%d xme_core_login_loginClientComponentWrapper_writePortOutRequest: Error when writing to port. Data handler returned error code %d.",
            __FILE__,
            __LINE__,
            returnValue
        );
...
)
{
    ...
    else
    {
        ...
        (
            XME_LOG_ERROR,
            "%s:%d xme_core_login_loginClientComponentWrapper_writePortOutLoginAcknowledgment: Error when writing to port. Data handler returned error code %d.",
            __FILE__,
            __LINE__,
            returnValue
        );

 ...
 *
 * $Id: loginManagerProcessResponseFunctionWrapper.c 4945 2013-09-04 07:37:46Z ruiz $
 */
...
)
{
    ...
    while (XME_CORE_EXEC_FUNCTION_STATE_TERMINATED != funDesc->state)
    {
        ...
        {
            xme_core_login_loginManagerProcessResponseFunction_step(functionParameter);

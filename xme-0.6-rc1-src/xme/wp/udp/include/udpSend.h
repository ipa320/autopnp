 ...
 *
 * $Id: udpSend.h 4887 2013-08-30 15:33:50Z ruiz $
 */
 ...
 * \param  hostname   hostname of the desination system
 * \param  port       port at which communication is to be sent.
 *
 ...
 * \param  key        The key to correctly identify the intended receipent.
 * \param  hostname    hostname of the destination system.
 * \param  port        port at which communication is to be opened at the hostname.
 * \param  isBroadcast    if this port is for broadcast
 *
